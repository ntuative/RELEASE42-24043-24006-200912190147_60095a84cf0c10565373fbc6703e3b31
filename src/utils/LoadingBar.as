package utils
{
   ...
   public class LoadingBar extends Sprite implements ICoreConfigStatusListener
   {
      ...
      private function updateBorder() : void
      {
         ...
         var_6.graphics.lineStyle(var_11,var_19);
      ...
      private function updateBar() : void
      {
         ...
         if(var_3 == null)
         {
            var_3 = new Sprite();
            addChild(var_3);
            var_3.x = var_11 + var_14;
            var_3.y = var_11 + var_14;
         }
         var_3.graphics.clear();
         var _loc1_:int = _height - var_11 * 2 - var_14 * 2;
         var _loc2_:int = (_width - var_11 * 2 - var_14 * 2) * var_18;
