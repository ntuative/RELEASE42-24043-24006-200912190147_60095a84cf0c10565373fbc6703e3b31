package com.sulake.core.communication
{
   ...
   public class CoreCommunicationManager extends Component implements ICoreCommunicationManager, ICoreUpdateReceiver
   {
      ...
      private var var_1538:IConnectionStateListener;
      ...
      {
         if(param1 == null || var_361 == null)
         {
            return null;
         }
         return var_361[param1] as IConnection;
      }
      ...
      public function getMessageParser(param1:Class) : IMessageParser
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         for each(var _loc6_ in var_1058)
         {
            _loc3_ = _loc6_;
            _loc6_;
            if(_loc3_ is param1)
      ...
      {
         var _loc2_:* = null;
         for each(var _loc5_ in var_361)
         {
            _loc2_ = _loc5_;
            _loc5_;
