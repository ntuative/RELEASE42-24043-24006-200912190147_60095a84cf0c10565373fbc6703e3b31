package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1131:int = 10000;
      ...
      private var var_606:IEncryption;
      
      private var var_605:int;
      
      private var var_316:ByteArray;
      ...
      private var var_315:IConnectionStateListener;
      
      private var var_510:IProtocol;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         _id = param1;
         var_607 = param2;
         var_316 = new ByteArray();
         var_726 = new MessageClassManager();
         var_167 = new Socket();
         var_317 = new Timer(const_1131,1);
         var_317.addEventListener(TimerEvent.TIMER,onTimeOutTimer);
      ...
      {
         var_317.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","TimeOut in " + (getTimer() - var_605));
      ...
      {
         var_317.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","SecurityError in " + (getTimer() - var_605));
      ...
      {
         var_317.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","Connected in " + (getTimer() - var_605));
         dispatchEvent(param1);
      }
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc5_:ByteArray = var_510.encoder.encode(_loc4_,param1.getMessageArray(),param2);
         if(var_315)
         {
            var_315.messageSent(_loc5_.toString());
         }
         if(var_606 != null)
         {
            _loc3_ = var_606.encipher(_loc5_);
         }
         else
         {
            _loc3_ = _loc5_;
      ...
      public function init(param1:String, param2:uint = 0) : Boolean
      {
         if(var_315)
         {
            var_315.connectionInit(param1,param2);
         }
      ...
      {
         var_607.addConnectionMessageEvent(_id,param1);
      }
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         while(false)
         {
            var_316.writeByte(var_167.readUnsignedByte());
         }
      }
      ...
      {
         var_317.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","Completed in " + (getTimer() - var_605));
         dispatchEvent(param1);
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var _loc2_:uint = var_510.getMessages(var_316,_loc1_);
         ...
         for each(_loc4_ in _loc1_)
         {
            ...
            if(var_315)
            {
               var_315.messageReceived(_loc5_ + " " + _loc6_);
            }
            _loc7_ = var_726.getMessageEventClasses(_loc5_);
            _loc8_ = new Array();
            for each(_loc9_ in _loc7_)
            {
               _loc13_ = var_607.getMessageEvents(this,_loc9_);
            ...
            for each(_loc12_ in _loc8_)
            {
               ...
               if(_loc14_ != null)
               {
                  ...
                  if(_loc14_ != _loc11_)
                  {
                     ...
                     _loc10_ = var_607.getMessageParser(_loc14_);
                     if(_loc10_.flush())
                     {
         ...
         else if(_loc2_ > 0)
         {
            ...
            _loc18_.writeBytes(var_316,_loc2_);
            var_316 = _loc18_;
         }
      }
      ...
      {
         var_317.delay = param1;
      }
      
      private function onIOError(param1:IOErrorEvent) : void
      {
         var_317.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","IOError in " + (getTimer() - var_605));
         switch(param1.type)
         {
      ...
      {
         var_317.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","Closed in " + (getTimer() - var_605));
         dispatchEvent(param1);
      }
      ...
      override public function toString() : String
      {
         ...
         return _loc1_ + ("Encryption: " + var_606 + "\n");
      }
   }
}
