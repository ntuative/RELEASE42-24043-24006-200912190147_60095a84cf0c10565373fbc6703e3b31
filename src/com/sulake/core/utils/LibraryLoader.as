package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1366:uint = 2;
      
      protected static const const_1365:uint = 1;
      
      protected static const const_1368:int = 5;
      
      protected static const const_1061:uint = 7;
      
      protected static const const_1364:uint = 4;
      
      protected static const const_1367:uint = 3;
       
      
      protected var var_864:int;
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         if(var_416 == LibraryLoader.const_1367)
         {
            if(analyzeLibrary())
            {
               var_416 |= 0;
         ...
         if(var_416 == LibraryLoader.const_1061)
         {
            var_1293 = true;
            prepareLibrary();
            removeEventListeners();
      ...
      protected function handleHttpStatus(param1:int) : Boolean
      {
         if(param1 >= 400)
         {
            if(var_864 > 0)
            {
               var_1.close();
               var_1.unload();
               addRequestCounterToUrlRequest(var_305,const_1368 - var_864);
