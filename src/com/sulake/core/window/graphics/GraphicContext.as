package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_997:uint = 256;
      ...
      public static const const_1531:uint = 128;
      
      public static const const_1431:uint = 64;
      
      public static const const_688:uint = 4;
      
      public static const const_1317:uint = 0;
      
      public static const const_1339:uint = 16;
      
      public static const const_726:uint = 1;
      ...
      protected var var_1525:Boolean;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_795:
               ...
               break;
            case GraphicContext.const_1114:
               setDisplayObject(new Shape());
               break;
            case GraphicContext.const_1339:
         ...
         if(var_581)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new BitmapData(width,height,var_1525,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new BitmapData(1,1,var_1525,16777215);
                  }
                  var_359 += bitmap.width * bitmap.height * 4;
               }
