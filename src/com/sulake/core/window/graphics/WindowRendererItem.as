package com.sulake.core.window.graphics
{
   ...
   public class WindowRendererItem implements IDisposable
   {
      ...
      private static const const_739:uint = 1;
      
      private static const const_740:uint = 2;
      ...
      public function invalidate(param1:IWindow, param2:Rectangle, param3:uint) : Boolean
      {
         ...
         switch(param3)
         {
            ...
            case WindowRedrawFlag.RESIZE:
               ...
               _loc4_ = true;
               break;
            case WindowRedrawFlag.const_426:
            ...
            case WindowRedrawFlag.const_804:
               var_610 = var_611.getTheActualState(param1.type,param1.style,param1.state);
               if(var_610 != var_892)
               {
                  var_218 = true;
                  _loc4_ = true;
            ...
            case WindowRedrawFlag.const_827:
               ...
               break;
            case WindowRedrawFlag.const_222:
               _loc4_ = true;
         }
         if(_loc4_)
         {
      ...
      {
         return var_611.getTheActualState(param1.type,param1.style,param1.state) != var_892;
      }
      ...
      public function render(param1:IWindow, param2:Point, param3:Rectangle) : Boolean
      {
         var _loc4_:* = null;
         var _loc10_:* = 0;
         var _loc5_:uint = !!param1.background ? uint(const_740) : uint(const_481);
         var _loc6_:ISkinRenderer = resolveSkinRenderer(param1);
         if(_loc6_ != null)
         {
            _loc5_ = !!_loc6_.isStateDrawable(var_610) ? uint(const_739) : uint(_loc5_);
         }
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc5_ == const_739)
               {
                  ...
                  if(var_218)
                  {
                     ...
                     _loc6_.draw(param1,var_96,var_96.rect,var_610,false);
                  ...
                  if(param1.blend < 1 && param1.testParamFlag(WindowParam.const_32))
                  {
                     ...
                     _loc4_.draw(var_96,var_876,_colorTransform,null,param3,false);
                     param3.offset(-param2.x,-param2.y);
                  }
                  else
                  {
      ...
      {
         var _loc2_:ISkinRenderer = var_611.getSkinRendererByType(param1.type,param1.style);
         if(_loc2_ == null)
         {
            if(param1.style != WindowStyle.const_862)
            {
               _loc2_ = var_611.getSkinRendererByType(param1.type,WindowStyle.const_862);
            }
         }
         return _loc2_;
      }
