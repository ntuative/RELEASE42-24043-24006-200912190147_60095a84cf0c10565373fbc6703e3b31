package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IChildEntity, IGraphicContextHost
   {
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_106,WindowParam.const_138);
         var _loc2_:* = !testParamFlag(WindowParam.const_118,WindowParam.const_142);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_22.clone();
            if(_loc1_)
      ...
      {
         if(_state == WindowState.const_448)
         {
            return true;
         }
      ...
      protected function forwardWindowNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_1185:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1335:
               _loc2_ = "null";
               break;
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_30)
         {
            var_30 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_726,var_22);
      ...
      {
         var_374 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         _context.invalidate(this,var_22,WindowRedrawFlag.const_827);
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(var_937 || _loc3_.hasGraphicsContext())
         {
         ...
         if(param2 is MouseEvent)
         {
            switch(param2.type)
            {
               case MouseEvent.MOUSE_DOWN:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_840;
            ...
            switch(param2.type)
            {
               case WindowNotifyEvent.const_221:
                  ...
                  if(param1 == this)
                  {
                     ...
                     if(testParamFlag(WindowParam.const_168,WindowParam.const_138))
                     {
                        updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_169,WindowParam.const_142))
                     {
                        updateScaleRelativeToParent();
                     }
                     if(var_23 != null)
                  ...
                  break;
               case WindowNotifyEvent.const_466:
                  _context.invalidate(this,var_22.union(var_60),WindowRedrawFlag.const_426);
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_815,this,null));
                     if(var_23 != null)
                     {
                        var_23.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_234,var_23,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_311:
                  ...
                  break;
               case WindowNotifyEvent.const_427:
                  _context.invalidate(this,var_22,WindowRedrawFlag.const_804);
                  break;
               case WindowNotifyEvent.const_401:
                  _loc6_ = new Array();
               ...
               case WindowNotifyEvent.const_396:
                  if(!(var_29 & 0))
                  {
                     ...
                     {
                        setupGraphicsContext();
                        _context.invalidate(this,var_22,WindowRedrawFlag.const_426);
                     }
                  }
                  else if(var_29 & 0)
                  {
               ...
               case WindowNotifyEvent.const_204:
                  ...
                  break;
               case WindowNotifyEvent.const_424:
                  var_23.getRegionProperties(null,var_286);
                  updateScaleRelativeToParent();
                  break;
               case WindowNotifyEvent.const_314:
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(var_937 || _loc2_.hasGraphicsContext())
         {
            setupGraphicsContext();
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            if(_loc7_ == WindowParam.const_350)
            {
               param1 -= (param3 - 0) / 2;
               _loc5_ = true;
            }
            ...
            _loc7_ = uint(var_29 & 0);
            if(_loc7_ == WindowParam.const_413)
            {
               param2 -= (param4 - 0) / 2;
               _loc5_ = true;
            }
            else if(_loc7_ == WindowParam.const_415)
            {
               param2 -= param4 - 0;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            ...
            if(_loc6_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_508,this,null,true);
               update(this,_loc10_);
               if(_loc10_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc6_)
            {
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_221,this,null));
            }
         }
      }
      ...
      public function lock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1183,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         setStateFlag(WindowState.const_62,true);
         _loc1_.type = WindowNotifyEvent.const_1290;
         update(this,_loc1_);
         return true;
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(var_23 != param1)
         {
            ...
            if(var_23 != null)
            {
               var_286 = var_23.rectangle.clone();
               var_60.x = var_22.x;
               var_60.y = var_22.y;
               var_60.width = var_22.width;
               var_60.height = var_22.height;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_455,this,var_23));
            }
            else
            {
               var_286.x = 0;
               ...
               var_286.width = 0;
               var_286.height = 0;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_787,this,_loc2_));
            }
         }
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,var_239,_type,var_86,var_29,_context,var_22,null,var_580,properties,var_578.concat(),_id) as WindowController;
         _loc2_.var_499 = var_499;
         _loc2_.var_308 = var_308;
         _loc2_.var_870 = var_870;
         _loc2_.var_286 = var_286.clone();
      ...
      public function unlock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1303,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      protected function forwardMouseEvent(param1:MouseEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_DOWN:
               ...
               break;
            case MouseEvent.MOUSE_UP:
               _loc2_ = !!_loc6_ ? "null" : WindowMouseEvent.const_567;
               break;
            case MouseEvent.MOUSE_WHEEL:
               _loc2_ = "null";
         }
