package com.sulake.core.window.utils
{
   ...
   public class WindowMouseOperator implements IDisposable
   {
      ...
      protected var var_500:Point;
      
      protected var var_122:DisplayObject;
      
      private var _disposed:Boolean = false;
      
      protected var var_1044:uint;
      ...
      public function operate(param1:int, param2:int) : void
      {
         _mouse.x = param1;
         _mouse.y = param2;
         getMousePositionRelativeTo(_window,_mouse,var_500);
      ...
      public function end(param1:IWindow) : IWindow
      {
         ...
         if(_working)
         {
            if(_window == param1)
            {
               ...
               if(true)
               {
                  _window.removeEventListener(WindowEvent.const_351,clientWindowDestroyed);
               }
               _window = null;
               _working = false;
            }
      ...
      public function begin(param1:IWindow, param2:uint = 0) : IWindow
      {
         ...
         if(param1 && !param1.disposed)
         {
            ...
            _window.addEventListener(WindowEvent.const_351,clientWindowDestroyed);
            _working = true;
         }
         return _loc3_;
      }
