package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1505:String = "_INCLUDE";
      
      public static const const_960:String = "_EXCLUDE";
      
      public static const const_1462:String = "_TEMP";
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(var_1048,var_1049);
         var_877 = new Dictionary();
         var_1307 = new Dictionary();
         ParamCodeTable.fillTables(var_877,var_1307);
         var_1308 = new Map();
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            ...
            for(_loc1_ in var_1307)
            {
               delete var_1307[_loc1_];
            }
            var_1308.dispose();
            var_1308 = null;
            _context = null;
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_960) == -1)
                  {
