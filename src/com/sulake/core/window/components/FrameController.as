package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1095:String = "_CONTENT";
      
      private static const const_1096:String = "_HEADER";
      
      private static const const_1094:String = "_SCALER";
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1267 == null)
         {
            var_1267 = findChildByTag(const_1096) as IHeaderWindow;
            if(!var_1267)
            {
      ...
      {
         return findChildByTag(const_1094) as IScalerWindow;
      }
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_248,false);
         }
      ...
      {
         return content != null && var_1293 ? content.iterator : new Iterator(this);
      }
      ...
      public function get content() : IWindowContainer
      {
         if(var_33 == null)
         {
            var_33 = findChildByTag(const_1095) as IWindowContainer;
            if(!var_33)
            {
