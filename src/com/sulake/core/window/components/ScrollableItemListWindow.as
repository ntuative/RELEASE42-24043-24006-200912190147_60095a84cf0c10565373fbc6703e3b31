   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_337)
         {
            ...
            if(var_337)
            {
               var_337.addEventListener(WindowEvent.const_227,scrollBarEventProc);
               var_337.addEventListener(WindowEvent.const_217,scrollBarEventProc);
            }
         }
         return var_337;
      }
      ...
      override public function dispose() : void
      {
         if(var_337)
         {
            var_337.removeEventListener(WindowEvent.const_227,scrollBarEventProc);
            var_337.removeEventListener(WindowEvent.const_217,scrollBarEventProc);
            var_337 = null;
         }
         if(_cachedItemList)
         {
      ...
      {
         if(param1.type == WindowEvent.const_227)
         {
            showScrollBar();
         }
