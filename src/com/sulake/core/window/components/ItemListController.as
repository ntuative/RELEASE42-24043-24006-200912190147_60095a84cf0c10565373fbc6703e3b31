package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow
   {
      ...
      protected var var_1042:Boolean = false;
      ...
      public function ItemListController(param1:String, param2:String, param3:uint, param4:uint, param5:uint, param6:WindowContext, param7:Rectangle, param8:IWindow, param9:Function = null, param10:Array = null, param11:Array = null, param12:uint = 0)
      {
         ...
         var_73 = 0;
         param5 |= 0;
         _horizontal = param3 == WindowType.const_279;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11,param12);
         var _loc13_:Rectangle = new Rectangle(0,0,width,height);
         _container = _context.create("_CONTAINER","",WindowType.const_286,WindowStyle.const_228,0 | 0 | 0 | 0,_loc13_,null,this,0,null,[WindowController.INTERNAL_CHILD_TAG,WindowController.EXCLUDE_CHILD_TAG]) as IWindowContainer;
         ...
         _container.addEventListener(WindowEvent.const_317,containerEventHandler);
         _container.addEventListener(WindowEvent.const_442,containerEventHandler);
         resizeOnItemUpdate = var_1042;
      }
      ...
      {
         return new Rectangle(var_498 * maxScrollH,var_496 * maxScrollV,width,height);
      }
      ...
      override public function dispose() : void
      {
         ...
         _container.removeEventListener(WindowEvent.const_317,containerEventHandler);
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("spacing",_spacing,PropertyStruct.const_88,_spacing != 0));
         _loc1_.push(new PropertyStruct("auto_arrange_items",var_704,PropertyStruct.const_56,var_704 != true));
         _loc1_.push(new PropertyStruct("scale_to_fit_items",var_497,PropertyStruct.const_56,var_497 != false));
         _loc1_.push(new PropertyStruct("resize_on_item_update",var_1042,PropertyStruct.const_56,var_1042 != false));
         return _loc1_;
      }
