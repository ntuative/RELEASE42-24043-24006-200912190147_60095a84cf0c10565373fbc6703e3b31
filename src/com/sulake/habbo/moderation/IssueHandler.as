package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_376:UserInfoCtrl;
      
      private var var_63:ModerationManager;
      
      private var var_924:UserInfoCtrl;
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         var_63.issueManager.releaseBundle(var_115.id);
         checkAutoHandling();
         dispose();
      }
      ...
      private function createView() : void
      {
         ...
         var_376 = new UserInfoCtrl(_window,var_63,_loc3_.message);
         var_924 = new UserInfoCtrl(_window,var_63,_loc3_.message);
         var_376.load(IWindowContainer(_window.findChildByName("caller_user_info")),var_115.getHighestPriorityIssue().reporterUserId);
         var _loc4_:IWindowContainer = IWindowContainer(_window.findChildByName("reported_user_info"));
         if(false)
         {
            var_924.load(_loc4_,var_115.reportedUserId);
         }
         else
         {
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         var_63.issueManager.closeBundle(var_115.id,1);
         checkAutoHandling();
         dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var_63.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),var_63,WindowTracker.const_797,_loc2_),_window,false,false,true);
      }
      ...
      {
         if(var_63 != null && false && var_115 != null)
         {
            var_63.issueManager.removeHandler(var_115.id);
         }
         this.dispose();
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            var_376 = new UserInfoCtrl(_window,var_63,_loc3_.message);
            var_376.load(IWindowContainer(_window.findChildByName("caller_user_info")),_loc2_);
         }
      }
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         var_63.issueManager.closeBundle(var_115.id,2);
         checkAutoHandling();
         dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         var_63.issueManager.closeBundle(var_115.id,3);
         checkAutoHandling();
         dispose();
      }
