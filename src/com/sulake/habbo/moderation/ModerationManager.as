package com.sulake.habbo.moderation
{
   ...
   public class ModerationManager extends Component implements IHabboModeration
   {
      ...
      private var var_1681:ModeratorInitMessageParser;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_1682:WindowTracker;
      ...
      private var var_1680:ModerationMessageHandler;
      
      private var var_1354:StartPanelCtrl;
      ...
      public function ModerationManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_1354 = new StartPanelCtrl(this);
         var_1682 = new WindowTracker();
      }
      
      public function userSelected(param1:int, param2:String) : void
      {
         Logger.log("USER SELECTED: " + param1 + ", " + param2);
         this.var_1354.userSelected(param1,param2);
      }
      ...
      private function method_3(param1:IConnection) : void
      {
         ...
         {
            _connection = param1;
            var_1680 = new ModerationMessageHandler(this);
         }
      }
