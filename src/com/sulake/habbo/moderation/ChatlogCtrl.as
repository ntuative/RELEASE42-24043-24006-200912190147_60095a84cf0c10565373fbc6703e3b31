package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1371:IMessageComposer;
      ...
      {
         var_851 = IWindowContainer(var_57.getXmlWindow("chatlog_roomheader"));
         var_852 = IWindowContainer(var_57.getXmlWindow("chatlog_chatline"));
         var_490 = new Timer(300,1);
         var_490.addEventListener(TimerEvent.TIMER,onResizeTimer);
         var_59 = IFrameWindow(var_57.getXmlWindow("chatlog_frame"));
         ...
         var_57.connection.send(var_1371);
      ...
      {
         var _loc5_:* = null;
         var _loc2_:IWindowContainer = IWindowContainer(var_851.clone());
         var _loc3_:ITextWindow = ITextWindow(_loc2_.findChildByName("room_name_txt"));
         if(param1.roomId > 0)
         {
            _loc3_.caption = param1.roomName;
            new OpenRoomTool(var_59,var_57,_loc3_,param1.isPublic,param1.roomId);
         }
         else
         {
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(var_852.clone());
         _loc4_.color = var_1276[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         var _loc5_:ITextWindow = ITextWindow(_loc4_.findChildByName("time_txt"));
         _loc5_.text = RoomVisitsCtrl.getFormattedTime(param2.hour,param2.method_11);
         ...
         if(param2.chatterId > 0)
         {
            ...
            new OpenUserInfo(var_59,var_57,_loc6_,param2.chatterId);
         }
