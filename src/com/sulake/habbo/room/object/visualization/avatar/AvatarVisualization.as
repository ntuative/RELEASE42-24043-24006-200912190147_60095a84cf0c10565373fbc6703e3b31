package com.sulake.habbo.room.object.visualization.avatar
{
   ...
   public class AvatarVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private var var_735:AvatarVisualizationData = null;
      ...
      {
         var_735 = param1 as AvatarVisualizationData;
         createSprites(const_1034);
         return true;
      }
      ...
      override public function update(param1:IRoomGeometry = null) : void
      {
         ...
         var _loc9_:Number = _loc3_.getNumber(RoomObjectVariableEnum.const_672);
         var _loc10_:Number = _loc3_.getNumber(RoomObjectVariableEnum.const_704);
         ...
         var _loc13_:Number = _loc7_ - var_1107;
         ...
         var _loc15_:Number = _loc3_.getNumber(RoomObjectVariableEnum.const_327);
         if(_loc15_ > 0)
         {
         ...
         var _loc19_:Boolean = var_276 != _loc2_.getUpdateID() || var_207 != param1.scale || var_184 != _loc3_.getUpdateID();
         var _loc20_:Boolean = _isAnimating || var_434 > 0;
         if(_loc19_ || _loc20_)
         {
            --var_434;
            _loc22_ = getTimer();
            if(var_511 != _loc6_)
            {
               for each(_loc48_ in var_393.getKeys())
               {
                  var_393.remove(_loc48_);
               }
               _loc5_ = null;
            }
            if(_loc5_ == null)
            ...
            _loc24_ = _loc3_.getNumber(RoomObjectVariableEnum.const_315);
            ...
            _loc26_ = _loc3_.getString(RoomObjectVariableEnum.const_648);
            _loc5_.appendAction(AvatarAction.const_546,_loc25_,_loc26_);
            _loc27_ = false;
            if(_loc25_ == "lay")
            {
            ...
            _loc28_ = _loc3_.getNumber(RoomObjectVariableEnum.const_390);
            if(_loc28_ > 0 && _loc5_.getScale() == AvatarScaleType.const_50)
            {
               _loc50_ = _loc3_.getNumber(RoomObjectVariableEnum.const_477);
               _loc51_ = 3;
               _loc52_ = _loc7_ - _loc50_;
               if(_loc52_ < _loc51_ * 1000)
               {
                  _loc5_.appendAction(AvatarAction.const_325,AvatarAction.const_1182[_loc28_]);
               }
            }
            _loc29_ = _loc3_.getNumber(RoomObjectVariableEnum.const_824);
            if(_loc29_ > 0)
            {
               _loc5_.appendAction(AvatarAction.const_806,_loc29_);
            }
            _loc30_ = _loc3_.getNumber(RoomObjectVariableEnum.const_785);
            if(_loc30_ > 0)
            {
               ...
               {
                  _loc5_.appendAction(AvatarAction.const_925,_loc30_);
               }
            }
            _loc31_ = _loc3_.getNumber(RoomObjectVariableEnum.const_566);
            _loc32_ = 0;
            if(_loc31_ > 0)
            {
               _loc56_ = _loc3_.getNumber(RoomObjectVariableEnum.const_725);
               _loc57_ = 100;
               _loc58_ = _loc7_ - _loc56_;
               if(_loc58_ < _loc57_ * 1000)
               {
                  _loc5_.appendAction(AvatarAction.const_1001,_loc31_);
                  _loc59_ = 1;
                  while(_loc59_ < 10)
                  {
            ...
            _loc33_ = _loc3_.getNumber(RoomObjectVariableEnum.const_873);
            if(_loc32_ > 0)
            {
               _loc33_ = _loc32_;
            }
            if(_loc33_ > 0)
            {
               _loc5_.appendAction(AvatarAction.const_909,_loc33_);
            }
            if(_loc8_)
            {
               _loc5_.appendAction(AvatarAction.const_403);
            }
            _loc34_ = _loc3_.getNumber(RoomObjectVariableEnum.const_347) > 0;
            if(_loc34_ || _loc12_)
            {
            ...
            if(_loc14_)
            {
               _loc5_.appendAction(AvatarAction.const_410);
            }
            _loc35_ = _loc3_.getNumber(RoomObjectVariableEnum.const_874);
            if(_loc35_ > 0)
            {
               _loc5_.appendAction(AvatarAction.const_663,_loc35_);
            }
            ...
            _loc42_ = getSprite(const_1581);
            if(_loc3_.getNumber(RoomObjectVariableEnum.const_829))
            {
               _loc42_.visible = true;
               _loc39_ = null;
               _loc38_ = null;
               ...
               if(_loc38_ != null)
               {
                  _loc39_ = var_735.getAvatarRendererAsset(_loc38_) as BitmapDataAsset;
               }
               if(_loc39_ != null)
               {
                  _loc42_.asset = _loc39_;
            ...
            var_736.push(getTimer() - _loc22_);
            if(false)
            {
               _loc76_ = 0;
               _loc77_ = "[";
               for each(_loc78_ in var_736)
               {
                  _loc76_ += _loc78_;
                  _loc77_ += "," + _loc78_;
               }
