package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_990:Point = null;
      
      private var var_480:Array;
      
      private var var_991:LayoutRasterizerData = null;
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc11_:* = null;
         var_992 = param1;
         var _loc3_:LayoutRasterizerData = var_68.getValue(var_677);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              var_1238 = RoomObjectVariableEnum.const_832;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              var_1238 = RoomObjectVariableEnum.const_884;
                           }
                           if(param2 != null)
                           {
      ...
      public function showAd(param1:IRoomObjectSpriteVisualization, param2:String = "", param3:Boolean = false) : void
      {
         ...
         {
            exchangeElementGraphics("billboard_img",var_1238);
         }
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(var_2054);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
      ...
      public function set layout(param1:String) : void
      {
         if(param1 != var_677)
         {
            ...
            _adBgIndex = -1;
            _adImgIndex = -1;
            var_991 = var_68.getValue(var_677);
         }
      }
      ...
      {
         var _loc1_:LayoutRasterizerData = var_68.getValue(var_677);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc5_:XMLList = var_991.elementList;
         if(_loc5_ == null)
         {
            return;
         }
         ...
         param2.offsetX = int(_loc8_.@x) + _loc9_.offsetX + var_990.x;
         param2.offsetY = int(_loc8_.@y) + _loc9_.offsetY + var_990.y;
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(var_346.indexOf(_loc10_) >= 0 && var_481)
            {
               param1 = var_346.indexOf(_loc10_);
               if(true)
               {
                  _loc9_ = _assetCollection.getAsset(var_479[param1]);
                  if(_loc9_ != null)
                  {
                     param2.asset = _loc9_.asset;
                  }
