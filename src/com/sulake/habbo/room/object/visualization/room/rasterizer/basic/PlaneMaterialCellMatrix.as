package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1298:int = const_278;
      ...
      public static const const_235:int = const_96;
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(var_1362 == const_96)
         {
            _loc5_ = new Rectangle(0,0,var_39.width,var_428);
         }
         else
         {
            _loc5_ = new Rectangle(0,0 - var_428,var_39.width,var_428);
         }
         ...
         if(isStatic)
         {
            if(var_39 != null)
            {
               if(var_39.width == param2 && var_39.height == param3 && Vector3d.isEqual(var_731,param4))
               {
                  if(param1 != null)
                  {
                     copyCachedBitmapOnCanvas(param1,var_428,param6,param7);
                     return param1;
                  }
                  return var_39;
               }
