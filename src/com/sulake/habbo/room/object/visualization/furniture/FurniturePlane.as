   ...
   public class FurniturePlane
   {
      ...
      public function setRotation(param1:Boolean) : void
      {
         if(param1 != var_2068)
         {
            if(!param1)
            {
               var_246.assign(var_571);
               var_247.assign(var_572);
            }
            else
            {
               var_246.assign(var_571);
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc9_:* = null;
         if(param1 == null || var_78 == null && var_599 != null || var_246 == null || var_247 == null || var_364 == null)
         {
            return false;
         }
         ...
         if(param1.updateId != var_1242)
         {
            ...
            if(_loc4_ != null && (_loc4_.x != var_997 || _loc4_.y != var_1580 || _loc4_.z != var_1572 || param1.scale != var_1576))
            {
               ...
               _loc6_ = param1.getScreenPosition(var_599);
               _loc7_ = _loc6_.z;
