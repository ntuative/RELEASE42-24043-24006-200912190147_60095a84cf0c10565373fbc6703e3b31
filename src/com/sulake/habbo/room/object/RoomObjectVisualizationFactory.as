package com.sulake.habbo.room.object
{
   ...
   public class RoomObjectVisualizationFactory extends Component implements IRoomObjectVisualizationFactory
   {
      ...
      public function getRoomObjectVisualizationData(param1:String, param2:String, param3:XML) : IRoomObjectVisualizationData
      {
         ...
         var _loc8_:* = null;
         var _loc4_:* = null;
         _loc4_ = var_470.getValue(param1) as IRoomObjectVisualizationData;
         if(_loc4_ != null)
         {
            return _loc4_;
         }
         ...
         switch(param2)
         {
            ...
            case RoomObjectVisualizationEnum.const_161:
               ...
               break;
            case RoomObjectVisualizationEnum.const_115:
      ...
      override public function dispose() : void
      {
         ...
         if(var_470 != null)
         {
            ...
            {
               _loc1_ = var_470.getWithIndex(_loc2_) as IRoomObjectVisualizationData;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
