package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, ICoreUpdateReceiver
   {
      ...
      private static const const_752:String = "overlay";
      
      private static const OBJECT_TYPE_SELECTION_ARROW:String = "selection_arrow";
      
      private static const const_1056:String = "tile_cursor";
      ...
      private var var_483:IAdManager = null;
      ...
      private var var_637:RoomMessageHandler = null;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         ...
         var_637 = new RoomMessageHandler(this);
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(var_70 != null)
         {
            ...
            {
               return var_70.deleteWallItem(var_116,var_117,param1);
            }
         }
         return false;
      }
               ...
               if(_loc8_ != null)
               {
                  ...
                  if(_loc11_ != null)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc15_ != null)
                        {
                           _loc16_ = _loc15_.getNumber(RoomVariableEnum.const_531) - 0.5;
                           _loc17_ = _loc15_.getNumber(RoomVariableEnum.const_646) - 0.5;
                           _loc18_ = _loc15_.getNumber(RoomVariableEnum.const_645) + 0.5;
                           _loc19_ = _loc15_.getNumber(RoomVariableEnum.const_589) + 0.5;
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_70 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_29)
            {
               return var_70.modifyWallItemData(var_116,var_117,param1,param3);
            }
         }
         return false;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_382 != null)
         {
            var_382.release(new IIDRoomObjectVisualizationFactory());
            var_382 = null;
         }
         if(var_48 != null)
         {
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_857;
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_904);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_984);
         ...
         if(_loc7_ != null)
         {
            if(_loc7_.getModel() != null)
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_945) > 0)
               {
                  ...
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_597,_loc5_);
                  }
               }
            }
         }
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_515,var_116,var_117,param2,param3));
            }
         }
      }
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_70 != null)
         {
            return var_70.modifyRoomObject(var_116,var_117,param1,param2,param3);
         }
         return false;
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(_loc6_ == null)
         {
            ...
            _loc9_ = var_289.getValue(_loc8_);
            if(_loc9_ == null)
            {
               _loc9_ = new RoomData(param1,param2,null);
               var_289.add(_loc8_,_loc9_);
            }
            if(param3 != null)
            {
         ...
         if(param4 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_632,param4);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param5 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_584,param5);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         return true;
      }
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_48 != null)
         {
            ...
            var_48.addObjectUpdateCategory(RoomObjectCategoryEnum.const_232);
            var_48.addObjectUpdateCategory(RoomObjectCategoryEnum.const_57);
            var_48.setContentLoader(var_26);
         }
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(var_70 != null)
         {
            var_70.handleRoomObjectEvent(param1,var_116,var_117);
         }
      }
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         {
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_216,_loc10_,true);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_318,param4,true);
            _loc12_.getModelController().setString(RoomObjectVariableEnum.const_300,_loc11_,true);
      ...
      {
         if(_roomObjectFactory == null || var_382 == null || var_48 == null || _roomRendererFactory == null || _communication == null || _habboConfiguration == null || !var_1858)
         {
            return;
         }
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_270,RoomObjectCategoryEnum.const_57);
      }
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1235,param3,param4,param5);
         _loc6_.getEventHandler().processUpdateMessage(_loc7_);
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:IRoomInstance = var_48.getRoom(getRoomIdentifier(var_116,var_117));
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_753,RoomObjectCategoryEnum.const_232);
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = getRoomCanvas(var_116,var_117,var_1170);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = getRoomCanvas(var_116,var_117,var_1170);
         if(_loc1_ != null)
         {
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_26 != null)
         {
            var_26.visualizationFactory = var_382;
         }
         initializeRoomManager();
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(_roomObjectFactory != null)
         {
            if(false)
            {
               _roomObjectFactory.events.addEventListener(RoomObjectMouseEvent.const_187,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectMouseEvent.const_392,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectMouseEvent.const_363,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectStateChangeEvent.const_236,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectStateChangeEvent.const_705,roomObjectEventHandler);
               ...
               _roomObjectFactory.events.addEventListener(RoomObjectFurnitureActionEvent.const_406,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectFurnitureActionEvent.const_434,roomObjectEventHandler);
               ...
               _roomObjectFactory.events.addEventListener(RoomObjectFurnitureActionEvent.const_475,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectFurnitureActionEvent.const_380,roomObjectEventHandler);
               ...
               _roomObjectFactory.events.addEventListener(RoomObjectMoveEvent.const_436,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectMoveEvent.const_360,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectRoomAdEvent.const_252,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectRoomAdEvent.const_353,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectRoomAdEvent.const_304,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectRoomAdEvent.const_292,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectRoomActionEvent.const_460,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectRoomActionEvent.const_951,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectRoomActionEvent.const_430,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(AvatarWalkWarpingWarningEvent.const_367,warningEventHandler);
            }
         }
      }
      ...
      public function initializeRoomObjectInsert(param1:int, param2:int, param3:int, param4:String = null) : Boolean
      {
         ...
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_637) != 0)
         {
            return false;
         }
         if(var_70 != null)
         {
            return var_70.initializeRoomObjectInsert(var_116,var_117,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         if(param1)
         {
            ...
            {
               _loc3_ = var_289.getWithIndex(_loc2_) as RoomData;
               if(_loc3_ != null)
               {
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_239,param1,param2,param3,RoomObjectCategoryEnum.const_35));
         }
         return true;
      }
            ...
            if(_loc13_ != null && _loc13_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_29:
                     _loc10_ = String(_loc13_.getModel().getNumber(RoomObjectVariableEnum.const_216));
                     break;
                  case RoomObjectCategoryEnum.const_35:
                     _loc10_ = _loc13_.getModel().getString(RoomObjectVariableEnum.const_154);
               }
            }
         }
      ...
      public function updateObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:IVector3d = null, param7:Number = NaN) : Boolean
      {
         ...
         if(isNaN(param7))
         {
            param7 = _loc8_.getModel().getNumber(RoomObjectVariableEnum.const_315);
         }
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_239,param1,param2,param3,RoomObjectCategoryEnum.const_29));
         }
         return true;
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_483.events.addEventListener(AdEvent.const_361,showRoomAd);
      }
      ...
      private function getOverlaySprite(param1:IRoomRenderingCanvas) : Sprite
      {
         ...
         return _loc2_.getChildByName(const_752) as Sprite;
      }
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:String = null, param7:uint = 0) : ImageResult
      {
         ...
         var _loc10_:int = var_534.reserveNumber();
         ...
         switch(_loc11_)
         {
            case RoomObjectCategoryEnum.const_33:
            case RoomObjectCategoryEnum.const_29:
               _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_216,int(param2));
               break;
            case RoomObjectCategoryEnum.const_35:
               _loc12_.getModelController().setString(RoomObjectVariableEnum.const_154,param2);
               break;
            case RoomObjectCategoryEnum.const_57:
               if(param2 != null)
               {
                  ...
                  if(_loc16_.length >= 3)
                  {
                     ...
                     _loc20_.addPlane(RoomPlaneData.const_136,new Vector3d(0,0,0),new Vector3d(10,0,0),new Vector3d(0,10,0));
                     _loc20_.addPlane(RoomPlaneData.const_137,new Vector3d(0,0,0),new Vector3d(0,10,0),new Vector3d(0,0,10));
                     _loc20_.addPlane(RoomPlaneData.const_137,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
                     _loc20_.addPlane(RoomPlaneData.const_261,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
                     _loc21_ = _loc20_.getXML();
                     _loc12_.getEventHandler().initialize(_loc21_);
                     _loc12_.getModelController().setString(RoomObjectVariableEnum.const_699,_loc17_);
                     _loc12_.getModelController().setString(RoomObjectVariableEnum.const_658,_loc18_);
                     _loc12_.getModelController().setString(RoomObjectVariableEnum.const_700,_loc19_);
                     if(param6 != null)
                     {
                        _loc22_ = null;
         ...
         {
            var_938.add(String(_loc10_),param5);
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_751,RoomObjectCategoryEnum.const_232);
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(_communication != null)
         {
            _connection = _communication.getHabboMainConnection(method_3);
            if(_connection != null)
            {
         ...
         if(_loc9_ != null)
         {
            ...
            if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
            {
               ...
               if(param4 == MouseEvent.CLICK)
               {
                  if(events != null)
                  {
                     events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_450,var_116,var_117,-1,RoomObjectCategoryEnum.const_202));
                  }
                  _loc13_ = "null";
               }
               ...
               if(var_70 != null)
               {
                  _loc14_ = new RoomObjectMouseEvent(_loc13_,const_270,const_484);
                  var_70.handleRoomObjectEvent(_loc14_,var_116,var_117);
               }
            }
         }
      }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         var _loc7_:IRoomRenderingCanvas = getRoomCanvas(var_116,var_117,var_1170);
         if(_loc7_ != null)
         {
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(var_26 != null)
         {
            ...
            var_26.addGraphicAsset(var_26.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_303,param1.image,true);
            var_26.addGraphicAsset(var_26.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_832,param1.adWarningL,true);
            var_26.addGraphicAsset(var_26.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_884,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_983,RoomObjectVariableEnum.const_303,param1.clickUrl);
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(var_70 != null)
         {
            var_70.cancelRoomObjectInsert(var_116,var_117);
         }
      }
      ...
      {
         return getRoomObjectBoundingRectangle(var_116,var_117,const_270,RoomObjectCategoryEnum.const_57,param1);
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(isPublicRoomWorldType(param6))
         {
            ...
            _loc7_.setNumber(RoomVariableEnum.const_637,1,true);
            _loc13_ = parseInt(_habboConfiguration.getKey("ads.billboard.displayDelayMillis","1000"));
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_786,_loc13_,true);
            if(var_26 != null)
            {
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_270,const_484,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_637,0,true);
         }
         ...
         if(param2 != null)
         {
            ...
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_531,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_645,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_646,_loc18_);
               _loc7_.setNumber(RoomVariableEnum.const_589,_loc19_);
               _loc14_ += _loc16_ * 423 + _loc17_ * 671 + _loc18_ * 913 + _loc19_ * 7509;
               if(_loc9_ != null && _loc9_.getModelController() != null)
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_890,_loc14_,true);
               }
            }
         }
         ...
         if(param4 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_632,param4);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param5 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_584,param5);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param2 != null)
         {
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_358,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_209);
                     ...
                     if(_loc28_ == 90 || _loc28_ == 180)
                     {
                        ...
                        _loc7_.setNumber(RoomObjectVariableEnum.const_904,_loc27_,true);
                        _loc7_.setNumber(RoomObjectVariableEnum.const_984,_loc28_,true);
                     }
                  }
                  _loc23_++;
               }
         ...
         _loc7_.createRoomObject(const_751,const_1056,RoomObjectCategoryEnum.const_232);
         _loc7_.createRoomObject(const_753,OBJECT_TYPE_SELECTION_ARROW,RoomObjectCategoryEnum.const_232);
         return _loc7_;
      }
