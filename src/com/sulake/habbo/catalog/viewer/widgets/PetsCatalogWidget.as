package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PetsCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function getPurchaseParameters() : String
      {
         ...
         if(var_371 >= var_284.length)
         {
            return "";
         }
         var petColor:IPetColor = var_284[var_371] as IPetColor;
         var color:uint = petColor.rgb;
         var breed:IBreed = var_519[var_1378] as IBreed;
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         if(var_371 < 0 || var_371 > var_284.length)
         {
            var_371 = 0;
         }
         updateImage();
      ...
      private function onApproveNameResult(param1:CatalogWidgetApproveNameResultEvent) : void
      {
         ...
         (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(var_898.getWithIndex(0),page,p);
      }
      ...
      override public function init() : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_193,onTextWindowEvent);
         var_898 = new Map();
         ...
         var_737 = getPetTypeIndexFromProduct(_loc5_.localizationId);
         var_284 = [];
         var_519 = [];
         if(page && false && page.viewer.catalog)
         {
            ...
            {
               _loc11_ = _loc10_.avatarRenderManager.petDataManager.getPetData(var_737);
               if(_loc11_)
               {
                  var_519 = _loc11_.breeds;
         ...
         var _loc6_:int = 0;
         while(_loc6_ < var_519.length)
         {
            _loc12_ = var_519[_loc6_] as IBreed;
            _loc3_.push(_loc4_.getKey(getRaceLocalizationKey(var_737,_loc12_.id),getRaceLocalizationKey(var_737,_loc12_.id)));
            _loc6_++;
         }
         var_898.add(var_737,_loc5_);
         ...
         events.addEventListener(WidgetEvent.const_903,onApproveNameResult);
         _loc5_ = var_898.getWithIndex(0);
         if(_loc5_ != null)
         {
      ...
      {
         var _loc7_:* = null;
         var _loc1_:Offer = var_898.getWithIndex(0);
         if(_loc1_ == null)
         {
            return;
         }
         ...
         if(var_371 >= 0 && var_371 < var_284.length)
         {
            _loc7_ = var_284[var_371] as IPetColor;
            if(_loc7_ != null)
            {
               _loc2_ = uint(_loc7_.rgb);
            }
         }
         var _loc3_:IBreed = var_519[var_1378] as IBreed;
         var _loc4_:IAvatarImage = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createPetImageNew(var_737,_loc3_.id,_loc2_,AvatarScaleType.const_50);
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.initActionAppends();
         _loc4_.appendAction(AvatarAction.const_325,AvatarAction.const_543);
