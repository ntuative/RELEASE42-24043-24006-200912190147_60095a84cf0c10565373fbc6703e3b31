package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1194:IScrollbarWindow;
      
      protected var var_1300:XML;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(var_547 != null)
         {
            var_547.visible = false;
            var_547.destroyGridItems();
         }
         if(var_1194 != null)
         {
         ...
         if(_loc3_ != null)
         {
            var_1196.text = "${" + _loc3_.name + "}";
            var_1197.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1196.text = "${" + _loc2_.localizationId + "}";
            var_1197.text = "${" + _loc2_.localizationId + "}";
         }
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_393:
                  ...
                  if(var_547 != null)
                  {
                     var_547.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_547,var_1194,var_1300);
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_258:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_325,AvatarAction.const_716);
                              _loc13_.appendAction(AvatarAction.const_663,_loc6_.productClassId);
      ...
      {
         var_1196 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1197 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_92 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1458 = new Point(var_92.x,var_92.y);
         var_547 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1194 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_547 == null)
         {
