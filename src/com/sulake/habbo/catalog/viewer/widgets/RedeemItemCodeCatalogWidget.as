package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         if(var_981 != null)
         {
            var_981.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         if(var_980 != null)
         {
            var_980.removeEventListener(WindowKeyboardEvent.const_127,windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         var_981 = _window.findChildByName("redeem") as IButtonWindow;
         if(var_981 != null)
         {
            var_981.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         var_980 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_980 != null)
         {
            var_980.addEventListener(WindowKeyboardEvent.const_127,windowKeyEventProcessor);
         }
      }
