package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc3_:Array = var_558[var_971] as Array;
      ...
      {
         var _loc2_:Offer = var_558[var_971][var_1997];
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_435 || _loc1_.pricingModel == Offer.const_440)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc3_.productType == ProductTypeEnum.const_78 || _loc3_.productType == ProductTypeEnum.const_85)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        ...
                        if(var_970.indexOf(_loc5_) == -1)
                        {
                           var_970.push(_loc5_);
                           var_558.push(new Array());
                        }
                        _loc6_ = var_970.indexOf(_loc5_);
                        (var_558[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
      ...
      override protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         for each(_loc2_ in var_558)
         {
            if(var_1997 < _loc2_.length)
            {
               _loc3_ = _loc2_[var_1997] as Offer;
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         var_971 = var_869.getGridItemIndex(param1.view);
