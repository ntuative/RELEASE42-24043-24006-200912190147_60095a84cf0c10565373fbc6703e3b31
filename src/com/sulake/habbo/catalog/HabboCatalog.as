package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog
   {
      ...
      private var var_208:IMarketPlace;
      
      private var _localization:ICoreLocalizationManager;
      
      private var var_589:PurchaseConfirmationDialog;
      
      private var var_832:IHabboSoundManager;
      
      private var var_313:ICatalogViewer;
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         var_187.credits = _loc3_.balance;
         updatePurse();
         if(!var_1535 && var_832 != null)
         {
            var_832.playSound(HabboSoundTypesEnum.const_886);
         }
         var_1535 = false;
      }
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_89:
               var_1054 = param1.session.isPrivateRoom;
               if(var_87 != null)
               {
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         {
            var_198.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_48,HabboToolbarIconEnum.CATALOGUE,_mainContainer));
         }
         if(false)
         {
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         var_187.clubDays = Math.max(0,_loc2_.daysToPeriodEnd);
         var_187.clubPeriods = Math.max(0,_loc2_.periodsSubscribedAhead);
         updatePurse();
      ...
      public function showPurchaseConfirmation(param1:Offer, param2:ICatalogPage, param3:String = "") : void
      {
         ...
         else
         {
            if(var_589 == null)
            {
               var_589 = new PurchaseConfirmationDialog(_localization);
            }
            _loc7_ = [];
            if(_friendList != null)
            {
            ...
            var_589.showOffer(this,param1,param2,param3,_loc7_);
         }
      }
      ...
      private function createMarketPlace() : void
      {
         if(var_208 == null)
         {
            var_208 = new MarketPlaceLogic(this,_windowManager);
         }
      }
      ...
      {
         var_198.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_112,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function onPixelsBalance(param1:IMessageEvent) : void
      {
         ...
         var_187.pixels = _loc2_.amount;
         updatePurse();
         if(!var_1536 && var_832 != null)
         {
            var_832.playSound(HabboSoundTypesEnum.const_819);
         }
         var_1536 = false;
      }
      ...
      private function updatePurse() : void
      {
         ...
         _localization.registerParameter("catalog.purse.creditbalance","balance",String(var_187.credits));
         _localization.registerParameter("catalog.purse.pixelbalance","balance",String(var_187.pixels));
         _localization.registerParameter("catalog.purse.clubdays","days",String(var_187.clubDays));
         _localization.registerParameter("catalog.purse.clubdays","months",String(var_187.clubPeriods));
         if(false)
         {
            return;
         }
      ...
      private function createCatalogViewer() : void
      {
         ...
         var_313 = new CatalogViewer(this,_loc1_,_roomEngine) as ICatalogViewer;
      }
