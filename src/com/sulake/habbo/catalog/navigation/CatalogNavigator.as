package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2270:String = "magic.credits";
      ...
      public function CatalogNavigator(param1:IHabboCatalog, param2:IWindowContainer)
      {
         ...
         if(_scrollBar != null)
         {
            ...
            _scrollBar.addEventListener(WindowEvent.const_598,activateScrollbar);
            _scrollBar.addEventListener(WindowEvent.const_227,activateScrollbar);
      ...
      private function openCreditsPage() : void
      {
         ...
         var _loc1_:* = var_69.configuration.getKey("client.credits.embed.enabled","false") == "true";
         if(false && _loc1_)
         {
         ...
         {
            _loc2_ = var_69.configuration.getKey("link.format.credits","/credits");
            var_69.windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,onExternalLink);
      ...
      {
         var_69.openCatalogPage(var_2247,true);
      }
      ...
      public function activateNode(param1:ICatalogNode) : void
      {
         ...
         var_69.loadCatalogPage(param1.pageId);
         var_69.events.dispatchEvent(new CatalogPageOpenedEvent(param1.pageId,param1.localization));
      }
      ...
      public function openFrontPage() : void
      {
         ...
         var_69.loadCatalogPage(_loc1_.pageId);
      }
      ...
      public function openPage(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            var_69.loadCatalogPage(_loc2_.pageId);
         }
