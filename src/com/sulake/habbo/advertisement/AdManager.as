package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_1795:BitmapData = null;
      ...
      private var var_1794:BitmapData = null;
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_361,0,0,_loc4_,var_1399,var_1794,var_1795));
         }
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         var _loc6_:* = null;
         var _loc7_:* = null;
         var_1793 = int(_config.getKey("interstitial.interval","30000"));
         var_1792 = int(_config.getKey("interstitial.show.time","5000"));
         var_1401 = int(_config.getKey("interstitial.max.displays.flash","-1"));
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         var_1133 = _loc2_.imageUrl;
         var_1399 = _loc2_.clickUrl;
         if(var_1133 != "" && var_1399 != "")
         {
            _loc3_ = var_1133;
            ...
            _loc4_ = new URLRequest(var_1133);
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         var_1134 = _loc2_.imageUrl;
         var_1796 = _loc2_.clickUrl;
         var_625 = getTimer();
         if(var_1134 != "")
         {
            _loc3_ = var_1134;
            ...
            var_222.start();
            _loc4_ = new URLRequest(var_1134);
            _loc5_ = _assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_428,0,0,param1.bitmapData,var_1796));
            var_625 = getTimer();
         }
         else
         {
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_1795 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(var_1401 > 0 && var_1400 >= var_1401)
         {
            return false;
         }
         var _loc1_:int = getTimer() - var_625;
         if(_loc1_ > var_1793)
         {
            ++var_1400;
      ...
      {
         var_607 = param2 as IHabboCommunicationManager;
         if(var_607 == null)
         {
            return;
         }
         _connection = var_607.getHabboMainConnection(method_3);
         if(_connection != null)
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_356));
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_1794 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
