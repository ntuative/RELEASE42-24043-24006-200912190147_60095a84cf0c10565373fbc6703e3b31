package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private var var_1948:IScrollbarWindow;
      
      private var var_137:HabboMessenger;
      
      private var var_1454:IContainerButtonWindow;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         var_137 = param1;
         var_1454 = initButton("follow_friend",onFollowButtonClick,param2);
         _list = IItemListWindow(param2.findChildByName("msg_list"));
         var_1948 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_509 || param3.type == Message.const_530 ? param3.time + ": " : "";
      ...
      private function refreshList() : void
      {
         ...
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,var_462.messages.length - const_759);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < var_462.messages.length)
         {
            refreshEntry(true,_loc1_,var_462.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      public function refresh() : void
      {
         ...
         if(var_462 == null || _loc1_.id != var_462.id)
         {
            var_462 = _loc1_;
            refreshList();
            afterResize();
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_759 + const_1069)
         {
            refreshList();
            afterResize();
         }
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_137.send(new FollowFriendMessageComposer(var_462.id));
      }
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1068;
         param1.invalidate();
      }
   }
}
