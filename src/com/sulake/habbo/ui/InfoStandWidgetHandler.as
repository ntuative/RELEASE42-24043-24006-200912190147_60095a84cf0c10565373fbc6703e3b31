package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_29:
               ...
               {
                  _loc20_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_318);
            ...
            case RoomObjectCategoryEnum.const_35:
               ...
               if(_loc9_.type == RoomObjectTypeEnum.const_288)
               {
                  _container.roomSession.userDataManager.requestPetInfo(_loc9_.webID);
                  return null;
               }
               if(_loc9_.type == RoomObjectTypeEnum.const_368)
               {
                  _loc10_ = "null";
               ...
               {
                  if(_loc9_.type != RoomObjectTypeEnum.const_877)
                  {
                     return null;
                  }
                  _loc10_ = "null";
               ...
               if(_loc14_ != null)
               {
                  _loc11_.carryItem = _loc14_.getModel().getNumber(RoomObjectVariableEnum.const_566);
               }
               if(_loc10_ == RoomWidgetUserInfoUpdateEvent.const_210)
               {
                  _loc11_.realName = _container.sessionDataManager.realName;
               }
               if(_loc10_ == RoomWidgetUserInfoUpdateEvent.const_197)
               {
                  ...
                  if(_loc14_ != null)
                  {
                     _loc28_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_524);
                  ...
                  _loc11_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1334;
                  if(!_loc23_)
                  {
                  ...
                  if(!_loc24_)
                  {
                     _loc11_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_964;
                  }
                  if(!_loc25_)
                  {
               ...
               if(_loc10_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc12_.push(RoomWidgetUserInfoUpdateEvent.const_1184);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         if(_container != null && false)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_524);
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_223);
         _loc1_.push(RoomWidgetFurniActionMessage.const_633);
         _loc1_.push(RoomWidgetFurniActionMessage.const_655);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_659);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_542);
         _loc1_.push(RoomWidgetUserActionMessage.const_355);
         _loc1_.push(RoomWidgetUserActionMessage.const_630);
         _loc1_.push(RoomWidgetUserActionMessage.const_538);
         _loc1_.push(RoomWidgetUserActionMessage.const_1243);
         _loc1_.push(RoomWidgetPetCommandMessage.const_576);
         _loc1_.push(RoomWidgetPetCommandMessage.const_568);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_355)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_609:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_893,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_376:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_659:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_542:
               ...
               break;
            case RoomWidgetUserActionMessage.const_355:
            ...
            case RoomWidgetUserActionMessage.const_630:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_568:
