package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      private var var_1569:IHabboHelp = null;
      ...
      private var var_717:IRoomWidgetFactory = null;
      ...
      private var var_1064:IAvatarRenderManager = null;
      ...
      private var var_1570:uint = 16777215;
      
      private var var_69:IHabboCatalog = null;
      ...
      public function RoomDesktop(param1:IRoomSession, param2:IAssetLibrary, param3:IConnection)
      {
         ...
         _widgets = new Map();
         var_209 = new Map();
         var_210 = new DesktopLayoutManager();
      }
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         if(_roomEngine != null && false)
         {
            ...
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_349,onRoomContentLoaded);
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_731,onRoomContentLoaded);
         }
      }
      ...
      public function init() : void
      {
         ...
         {
            var_595 = _roomEngine.loadRoomResources(var_47.roomResources);
            if(false)
            {
               var_9 = false;
         ...
         if(var_483 != null && true)
         {
            var_1063 = !var_483.showInterstitial();
         }
         checkInterrupts();
      }
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         _roomEngine.modifyRoomCanvas(var_47.roomId,var_47.roomCategory,var_244[0],_loc2_.width,_loc2_.height);
      ...
      public function dispose() : void
      {
         ...
         if(_roomEngine != null && false)
         {
            ...
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_349,onRoomContentLoaded);
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_731,onRoomContentLoaded);
         }
         _roomEngine = null;
         var_34 = null;
         var_717 = null;
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(var_1570);
      ...
      {
         var_210.setLayout(param1,_windowManager);
         if(var_198 != null)
         {
            var_210.toolbarSize = var_198.size;
            var_210.toolbarOrientation = var_198.orientation;
         }
      }
      ...
      public function createWidget(param1:String) : void
      {
         ...
         _loc2_ = var_717.createWidget(param1);
         if(_loc2_ == null)
         {
            return;
         }
         ...
         var_210.addWidgetWindow(_loc2_.mainWindow);
         ...
         param1 = "null";
         var _loc4_:RoomWidgetRoomViewUpdateEvent = new RoomWidgetRoomViewUpdateEvent(param1,var_210.roomViewRect);
      ...
      private function onToolbarRepositionEvent(param1:HabboToolbarEvent) : void
      {
         if(var_210 != null)
         {
            var_210.toolbarOrientation = param1.orientation;
         }
      }
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomEngineObjectEvent.const_116:
               ...
               processWidgetMessage(_loc5_);
               break;
            case RoomEngineObjectEvent.const_343:
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         var _loc20_:* = null;
         var _loc2_:Rectangle = var_210.roomViewRect;
         ...
         if(_loc7_ != null)
         {
            _loc12_ = _roomEngine.getRoomNumberValue(var_47.roomId,var_47.roomCategory,RoomVariableEnum.const_531);
            _loc13_ = _roomEngine.getRoomNumberValue(var_47.roomId,var_47.roomCategory,RoomVariableEnum.const_645);
            _loc14_ = _roomEngine.getRoomNumberValue(var_47.roomId,var_47.roomCategory,RoomVariableEnum.const_646);
            _loc15_ = _roomEngine.getRoomNumberValue(var_47.roomId,var_47.roomCategory,RoomVariableEnum.const_589);
      ...
      private function handleRoomAdClick(param1:RoomEngineObjectEvent) : void
      {
         ...
         var _loc4_:String = _loc3_.getString(RoomObjectVariableEnum.const_300);
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_439:
               ...
               var_164 = _windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.WINDOW_TYPE_TOOLTIP,WindowStyle.const_228,WindowParam.const_75) as IToolTipWindow;
      ...
      private function onRoomContentLoaded(param1:RoomContentLoadedEvent) : void
      {
         ...
         var _loc2_:int = var_595.indexOf(param1.contentType);
         if(_loc2_ != -1)
         {
      ...
      {
         if(var_34 != null && var_47 != null && var_1063 && var_9)
         {
            var_34.startSession(var_47);
            processEvent(new RoomWidgetLoadingBarUpdateEvent(RoomWidgetLoadingBarUpdateEvent.const_260));
         }
      }
      ...
      {
         var _loc3_:IWindowContainer = var_210.getRoomView() as IWindowContainer;
         if(_loc3_ == null)
         {
            return;
         }
