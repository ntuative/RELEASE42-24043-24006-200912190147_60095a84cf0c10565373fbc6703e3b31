package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_475:Point = null;
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           if(_loc13_ == null)
                           {
                              if(false)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_288:
      ...
      {
         return [RoomWidgetChatMessage.const_656,RoomWidgetChatSelectAvatarMessage.const_722];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_656:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_133,_container.roomSession,0,"Version 24043-24006-200912190101");
                           ...
                           case ":furni":
                              ...
                              {
                                 _loc4_ = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_386);
                                 _container.processWidgetMessage(_loc4_);
                              }
                              return null;
                           case ":pickall":
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_722:
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_821 > 0)
            {
               _loc5_ = Number(_loc4_.scale / var_821);
            }
            if(var_475 == null)
            {
               var_474.x = 0;
               var_474.y = 0;
               var_474.z = 0;
               var_475 = _loc4_.getScreenPoint(var_474);
               var_821 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            var_474.x = 0;
            var_474.y = 0;
            var_474.z = 0;
            _loc8_ = _loc4_.getScreenPoint(var_474);
            if(_loc8_ != null)
            {
               if(_loc8_.x != var_475.x || _loc8_.y != var_475.y)
               {
                  _loc9_ = PointMath.sub(_loc8_,PointMath.mul(var_475,_loc5_));
