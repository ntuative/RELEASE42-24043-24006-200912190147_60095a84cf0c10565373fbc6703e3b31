package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      private var var_2103:RoomThumbnailRenderer;
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         var_2103 = new RoomThumbnailRenderer(param1);
         var_961 = new TagRenderer(param1,hideInstantly);
      }
      
      private function refreshOwnerName() : void
      {
         refreshTextWithCaption("roomowner",var_181,var_121.ownerName);
         var _loc1_:ITextWindow = ITextWindow(var_181.findChildByName("roomowner"));
         if(true)
         {
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(var_181.findChildByName("extra_cont"));
         Util.hideChildren(_loc1_);
         var_961.refreshTags(_loc1_,var_121.tags);
         refreshTextWithCaption("rating",_loc1_,"undefined");
         if(false)
         {
            refreshTextWithCaption("startedat",_loc1_,"undefined");
         }
         var_2103.refreshThumbnail(_loc1_,var_121.thumbnail,false);
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         if(var_181 == null)
         {
            var_181 = IWindowContainer(param1.findChildByName("details_container"));
         }
         var_181.visible = true;
         Util.hideChildren(var_181);
         refreshRoomName(var_181,var_121);
         if(true)
         {
         }
         refreshOwnerName();
         refreshTextWithCaption("roomctg",var_181,!true ? getEventCtg(var_121.categoryId) : getRoomCtg(var_121.categoryId));
         refreshRoomDesc(var_181,var_121);
         refreshExtraCont();
         refreshInfo(var_181,"trading_allowed",var_121.allowTrading);
         refreshInfo(var_181,"doormode_doorbell",false);
         refreshInfo(var_181,"doormode_password",false);
         Util.moveChildrenToColumn(var_181,["roomname","roomctg_cont","roomowner_cont","roomdesc","extra_cont","doormode_doorbell","doormode_password","trading_allowed"],0,0);
         var_181.height = Util.getLowestPoint(var_181);
      }
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_213,Tabs.const_211,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
