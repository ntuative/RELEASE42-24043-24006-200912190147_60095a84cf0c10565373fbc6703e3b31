package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_2289:Dictionary;
      ...
      private var var_2104:ISessionDataManager;
      
      private var var_2105:RoomCreateViewCtrl;
      ...
      private var var_1266:RoomInfoViewCtrl;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_1266 = new RoomInfoViewCtrl(this);
         var_2105 = new RoomCreateViewCtrl(this);
         var_2103 = new RoomThumbnailRenderer(this);
         var_1003 = new GuestRoomPasswordInput(this);
         var_328 = new GuestRoomDoorbell(this);
         var_386 = new Tabs(this);
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_487.startSearch(Tabs.const_213,Tabs.const_322,param1);
      ...
      public function animateWindowOpen(param1:IWindowContainer) : void
      {
         ...
         {
            var_198.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_48,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         if(var_198 != null)
         {
            var_198.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_112,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.settings != null && this._data.settings.homeRoomId > 0)
            {
               var_198.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_112,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_2104 = param2 as ISessionDataManager;
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         var_487.startSearch(Tabs.const_251,Tabs.const_186);
         var_386.getTab(Tabs.const_251).tabPageDecorator.tabSelected();
      }
