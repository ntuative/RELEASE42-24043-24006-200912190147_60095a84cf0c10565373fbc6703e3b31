package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      private const const_1384:Number = 0.2;
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(category == FurniCategory.const_711)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < _items.length)
      ...
      public function initImage() : void
      {
         ...
         if(var_2173 == FurniModel.const_41)
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               _window.blend = const_1384;
               _loc1_.blend = const_1384;
            }
            else
            {
         ...
         if(_loc5_)
         {
            if(var_1299 && getRecyclableCount() > 0)
            {
               _loc5_.bitmap = var_2172;
               _loc5_.visible = true;
            }
            else
            {
