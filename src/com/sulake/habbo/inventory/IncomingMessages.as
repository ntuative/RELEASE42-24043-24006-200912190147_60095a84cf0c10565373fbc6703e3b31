package com.sulake.habbo.inventory
{
   ...
   public class IncomingMessages
   {
      ...
      public function onAvatarEffects(param1:IMessageEvent) : void
      {
         ...
         var_25.setInventoryCategoryInit(InventoryCategory.const_616);
         _loc2_.refreshViews();
         var_25.notifyChangedEffects();
      }
      ...
      public function onAchievements(param1:IMessageEvent) : void
      {
         ...
         _loc4_.refreshViews();
         var_25.setInventoryCategoryInit(InventoryCategory.const_280);
      }
      ...
      public function onFurniList(param1:IMessageEvent) : void
      {
         ...
         while(_loc12_ < _loc3_.length)
         {
            ...
            if(_loc9_.indexOf(_loc6_.stripId) == -1)
            {
               ...
               {
                  _loc5_ = new FloorItem(_loc6_.stripId,_loc6_.classId,_loc6_.objId,_loc6_.category,_loc6_.isGroupable,_loc6_.isTradeable,_loc6_.isRecyclable,_loc6_.isSellable,_loc6_.stuffData,_loc6_.method_4,0,0,0,_loc6_.slotId,_loc6_.songId);
               }
               else
               {
      ...
      public function onBadges(param1:IMessageEvent) : void
      {
         ...
         _loc3_.updateView();
         var_25.setInventoryCategoryInit(InventoryCategory.const_229);
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         var_25.setInventoryCategoryInit(InventoryCategory.const_447);
         var _loc4_:FurniModel = var_25.furniModel;
         if(_loc4_ != null)
         {
            _loc4_.updateView();
