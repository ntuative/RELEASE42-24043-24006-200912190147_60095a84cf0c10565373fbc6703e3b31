package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_517:BitmapData;
      
      private var var_896:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            var_517 = BitmapData(_loc7_.content);
         }
         ...
         _thumbWidth = var_517.width;
         var_97 = var_517.height;
         var_895 = param5;
         var_733 = param6;
         var_220 = Math.floor(var_895 / _thumbWidth);
         var_32 = new BitmapData(var_895,var_733);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(var_32.height < var_733)
         {
            _loc12_ = new BitmapData(var_32.width,var_733);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(var_517.width,var_517.height);
         if(param2)
         {
            _loc3_.copyPixels(_itemBgImageSelected,var_517.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(var_517,var_517.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
      ...
      private function getList() : Array
      {
         ...
         if(var_896 != null)
         {
            _loc1_ = var_896.getDrawableList();
         }
      ...
      public function updateImageFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         var_433 = resolveRowCountFromList();
         if(var_433 == 0)
         {
            var_32 = new BitmapData(var_895,var_733);
            return;
         }
         var_32 = new BitmapData(Math.max(var_220 * _thumbWidth,var_895),Math.max(var_433 * var_97,var_733),true,16777215);
         var_32.fillRect(var_32.rect,4294967295);
         var _loc1_:int = 0;
         var _loc2_:Array = getList();
         var _loc3_:int = 0;
         while(_loc3_ < var_433)
         {
            _loc4_ = 0;
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == var_220 && var_32.height < _loc3_.y * var_97)
         {
         ...
         _loc4_ = new Rectangle(0,0,_thumbWidth * (var_220 - 1),var_97);
         _loc2_.copyPixels(var_32,_loc4_,new Point(_thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(_thumbWidth * (var_220 - 1),0,_thumbWidth,var_32.height);
         _loc2_.copyPixels(var_32,_loc4_,new Point(0,var_97),null,null,true);
         _loc4_ = new Rectangle(0,var_97,_thumbWidth * (var_220 - 1),0 - var_97);
