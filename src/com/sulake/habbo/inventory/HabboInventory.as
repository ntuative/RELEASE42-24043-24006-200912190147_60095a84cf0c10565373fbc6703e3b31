package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private const const_1577:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(var_34 != null)
         {
            ...
            var_34.events.removeEventListener(RoomSessionEvent.const_92,roomSessionEventHandler);
            var_34.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_463,roomSessionEventHandler);
      ...
      {
         return EffectsModel(var_52.getValue(InventoryCategory.const_616));
      }
      ...
      {
         var_187.clubPeriods = param1;
         var_187.clubDays = param2;
         var_187.clubHasEverBeenMember = param3;
      ...
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_851));
      }
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(const_1577);
         }
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(var_52.getValue(InventoryCategory.const_280));
      }
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_712.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_712.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         return TradingModel(var_52.getValue(InventorySubCategory.const_226));
      }
      ...
      {
         return var_187.creditBalance;
      }
      
      public function get marketplaceModel() : MarketplaceModel
      {
         return var_52.getValue(InventoryCategory.const_447) as MarketplaceModel;
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1310 = new IncomingMessages(this);
      ...
      {
         return var_187.clubHasEverBeenMember;
      }
      
      public function get clubPastPeriods() : int
      {
         return var_187.clubPastPeriods;
      }
      ...
      {
         return BadgesModel(var_52.getValue(InventoryCategory.const_229));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_34.events.addEventListener(RoomSessionEvent.const_92,roomSessionEventHandler);
         var_34.events.addEventListener(RoomSessionPropertyUpdateEvent.const_463,roomSessionEventHandler);
         ...
         var_52.add(InventoryCategory.const_447,_loc3_);
