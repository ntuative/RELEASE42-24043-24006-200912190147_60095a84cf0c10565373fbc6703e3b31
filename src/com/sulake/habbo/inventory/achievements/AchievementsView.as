package com.sulake.habbo.inventory.achievements
{
   ...
   public class AchievementsView implements IInventoryView
   {
      ...
      private var var_88:AchievementsModel;
      ...
      public function updateList() : void
      {
         ...
         var _loc2_:Array = var_88.getAchievements();
         var _loc3_:int = 0;
      ...
      private function method_2(param1:Achievement) : IWindowContainer
      {
      ...
      public function updateListItem(param1:int, param2:Achievement) : void
      {
         ...
         var _loc4_:IWindowContainer = method_2(param2);
         if(_loc4_ != null)
         {
