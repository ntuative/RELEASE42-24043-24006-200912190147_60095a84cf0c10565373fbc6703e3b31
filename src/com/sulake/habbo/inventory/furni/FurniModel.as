package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboLocalizationManager, param8:IHabboConfigurationManager)
      {
         ...
         var_488 = new Timer(const_1106,1);
         ...
         while(_loc3_ < _loc2_.length)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               while(_loc5_ < _loc4_.length)
               {
                  ...
                  if(_loc6_.category == FurniCategory.const_711)
                  {
                     _loc7_ = 1;
                  }
                  _loc8_ = 0;
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Boolean = false) : GroupItem
      {
         ...
         var _loc7_:* = null;
         var _loc8_:* = null;
         if(param3 == FurniCategory.const_294)
         {
         ...
         if(var_691 == null)
         {
            var_691 = _windowManager.buildFromXML(_groupItemWindowBase) as IWindowContainer;
         }
         var _loc10_:IWindowContainer = var_691.clone() as IWindowContainer;
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_226:
               ...
               break;
            case InventorySubCategory.const_943:
               removeAllLocks();
               if(_view != null)
               {
                  _view.updateActionView();
      ...
      {
         _controller.checkCategoryInitilization(InventoryCategory.const_447);
      ...
      {
         if(var_849 && param1.type == RoomEngineObjectEvent.const_201)
         {
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_277 || _loc3_.category == FurniCategory.const_294 || _loc3_.category == FurniCategory.const_319)
         {
            if(param1)
            {
               return false;
      ...
      {
         var_404 = new Map();
         var_404.add(const_41,new Array());
