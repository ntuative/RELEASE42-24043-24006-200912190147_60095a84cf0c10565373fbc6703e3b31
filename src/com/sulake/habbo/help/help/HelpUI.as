package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_1541:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         _windowManager.registerLocalizationParameter("info.client.version","version","24043-24006-200912190101");
         var_198 = param5;
         var_104 = new Map();
         var_104.add(HabboHelpViewEnum.const_1197,IHelpViewController(new PlaceholderView(this,_windowManager,_assetLibrary)));
         var_104.add(HabboHelpViewEnum.const_145,IHelpViewController(new HelpMainView(this,_windowManager,_assetLibrary)));
         var_104.add(HabboHelpViewEnum.const_429,IHelpViewController(new FaqBrowseTopView(this,_windowManager,_assetLibrary)));
         var_104.add(HabboHelpViewEnum.const_266,IHelpViewController(new FaqBrowseCategoryView(this,_windowManager,_assetLibrary)));
         var_104.add(HabboHelpViewEnum.const_198,IHelpViewController(new FaqBrowseEntry(this,_windowManager,_assetLibrary)));
         var_104.add(HabboHelpViewEnum.const_537,IHelpViewController(new FaqBrowseSearchResults(this,_windowManager,_assetLibrary)));
         var_104.add(HabboHelpViewEnum.const_291,IHelpViewController(new CallForHelpTopicSelection(this,_windowManager,_assetLibrary)));
         var_104.add(HabboHelpViewEnum.const_643,IHelpViewController(new CallForHelpTextInput(this,_windowManager,_assetLibrary)));
         var_104.add(HabboHelpViewEnum.const_190,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary,"help_cfh_thanks")));
         ...
         var_104.add(HabboHelpViewEnum.const_792,IHelpViewController(new CallForHelpPendingItemView(this,_windowManager,_assetLibrary)));
         var_104.add(HabboHelpViewEnum.const_667,IHelpViewController(new CallForHelpReportUserSelection(this,_windowManager,_assetLibrary)));
      }
      ...
      private function addBackButtonWindow() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(var_243 == HabboHelpViewEnum.const_145 || false)
         {
            return;
         }
         if(var_363 == null)
      ...
      {
         return var_104.getValue(var_243);
      }
      ...
      {
         var_1540 = param1;
         var _loc2_:IHelpViewController = var_104.getValue(HabboHelpViewEnum.const_145) as IHelpViewController;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_190:
               ...
               break;
            case CallForHelpResultEnum.const_961:
      ...
      {
         var _loc3_:* = null;
         if(var_243 == HabboHelpViewEnum.const_145)
         {
            return;
         }
         if(true)
         {
            ...
            var_501.push(_loc3_.content as BitmapData);
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(var_501[1],var_501[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(var_501[0],var_501[0].rect,new Point(0,0));
         }
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         _window.height = _loc1_.height + var_1316;
         _window.width = _loc1_.width + var_1317;
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(_loc3_)
         {
            if(var_198 != null)
            {
               var_198.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_48,HabboToolbarIconEnum.HELP,_window));
            }
         }
      ...
      public function handleCallGuideBot() : void
      {
         ...
         hideUI();
         var_43.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_562));
      }
