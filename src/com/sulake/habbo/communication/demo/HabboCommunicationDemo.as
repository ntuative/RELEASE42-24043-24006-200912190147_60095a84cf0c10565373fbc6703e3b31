package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_1860:PseudoRandom;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _habboConfiguration:IHabboConfigurationManager;
      
      private var var_1430:ILogger;
      ...
      private var var_448:IKeyExchange;
      ...
      private function onDisconnectReason(param1:IMessageEvent) : void
      {
         ...
         switch(_loc2_)
         {
            case DisconnectReasonEvent.const_274:
               _loc3_ = _habboConfiguration.getKey("logout.banned.url");
               break;
            case DisconnectReasonEvent.const_788:
            ...
            case DisconnectReasonEvent.const_816:
               ...
               break;
            case DisconnectReasonEvent.const_790:
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_1861)
         {
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_639 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_639);
            _loc2_.send(_loc4_);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         param1.send(new VersionCheckMessageComposer(401,var_1172,var_1862));
         var _loc2_:String = "";
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var_448.generateSharedKey(_loc4_,10);
         var _loc5_:String = var_448.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_1860);
      ...
      {
         var_639 = _habboConfiguration.getKey("sso.ticket",null);
         var_1172 = _habboConfiguration.getKey("flash.client.url","");
         var_1862 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_174 == null)
         {
         ...
         if(var_639 != null)
         {
            var_77.mode = HabboConnectionType.const_444;
            var_77.initConnection(HabboConnectionType.const_241);
         }
      }
      
      private function receiveLoggerInterface(param1:IID, param2:IUnknown) : void
      {
         var_1430 = param2 as ILogger;
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_561);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_1860 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_77.mode)
         {
            case HabboConnectionType.const_444:
               ...
               var_941 = _loc4_;
               var_174.loadBannerImage(_loc7_ + "?token=" + var_941,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1209:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1304:
               var_942 = generateRandomHexString(30);
               var_448 = new DiffieHellman(new BigInteger(_habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(_habboConfiguration.getKey("connection.development.generator"),16));
               var_448.init(var_942);
               _loc8_ = var_448.getPublicKey(10);
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_941);
         ...
         var_448 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 100;
         while(_loc12_.length < 64)
         {
            var_942 = generateRandomHexString(30);
            var_448.init(var_942);
            _loc12_ = var_448.getPublicKey(10);
            _loc13_--;
            if(_loc13_ == 0)
            {
            }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         var_34.events.addEventListener(RoomSessionEvent.const_92,onRoomSessionEnded);
      }
