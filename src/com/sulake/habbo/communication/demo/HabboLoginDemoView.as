package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_340.shockwaveClientUrl = var_120.shockwaveClientUrl;
         var_340.ssoTicket = var_120.ticket;
         var_120.removeEventListener(SSOTicket.const_285,onParsedTicketSuccess);
         var_120.removeEventListener(SSOTicket.const_269,onParsedTicketFailure);
         var_120 = null;
      ...
      private function createWindow() : void
      {
         ...
         _window = var_340.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_284,HabboWindowStyle.const_40,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
      ...
      private function initSSOTicket() : void
      {
         ...
         var_120 = new SSOTicket(var_340.assets,_loc2_,_loc1_);
         var_120.addEventListener(SSOTicket.const_285,onParsedTicketSuccess);
         var_120.addEventListener(SSOTicket.const_269,onParsedTicketFailure);
      }
