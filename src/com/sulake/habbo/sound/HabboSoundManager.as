package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManager extends Component implements IHabboSoundManager
   {
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         _roomEngine.events.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_994,onPlayEvent);
      }
      ...
      private function storeVolumeSetting() : void
      {
         if(_connection != null)
         {
            _connection.send(new SetSoundSettingsComposer(int(var_601 * 100)));
         }
      }
      ...
      {
         var _loc2_:IConnection = _communication.getHabboMainConnection(method_3);
         if(_loc2_ != null)
         {
      ...
      public function playSound(param1:String) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:HabboSound = var_1484.getValue(param1);
         if(_loc2_ == null)
         {
            _loc3_ = "";
            switch(param1)
            {
               case HabboSoundTypesEnum.const_782:
                  _loc3_ = "sound_call_for_help";
                  break;
               case HabboSoundTypesEnum.const_1331:
               ...
               case HabboSoundTypesEnum.const_886:
                  ...
                  break;
               case HabboSoundTypesEnum.const_1155:
            ...
            var_1484.add(param1,_loc2_);
         }
         _loc2_.volume = var_601;
         _loc2_.play();
      }
   }
}
