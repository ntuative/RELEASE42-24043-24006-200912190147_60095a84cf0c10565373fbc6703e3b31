package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_301:int = 100;
      ...
      {
         return Math.ceil(this.var_237.length / const_301);
      }
      ...
      {
         if(this.var_837 >= this.getPageCount())
         {
            this.var_837 = Math.max(0,this.getPageCount() - 1);
         }
      }
      ...
      {
         checkPageIndex();
         return Math.min((this.var_837 + 1) * const_301,this.var_237.length);
      }
