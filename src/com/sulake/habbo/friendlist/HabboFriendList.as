package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      private var var_1590:IAvatarRenderManager;
      
      private var var_1336:AvatarSearchResults;
      
      private var var_137:IHabboMessenger;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_721:FriendRequests;
      
      private var var_1588:int;
      
      var var_343:FriendCategories;
      
      private var var_198:IHabboToolbar;
      
      private var var_1587:FriendListLookAndFeel;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_386:FriendListTabs;
      
      private var var_1589:IHabboNotifications;
      
      private var _localization:IHabboLocalizationManager;
      
      private var var_1335:OpenedToWebPopup;
      ...
      {
         var_1587 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_343 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1336 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1335 == null)
         {
            var_1335 = new OpenedToWebPopup(this);
         }
         var_1335.show(x,y);
      }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_721.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_721.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_386.findTab(FriendListTab.const_99).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(var_721.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      public function getFriend(param1:int) : IFriend
      {
         ...
         return var_343.findFriend(param1);
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_721 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_343.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_343.addCategory(new FriendCategory(FriendCategory.const_818,getText("friendlist.friends")));
         var_343.addCategory(new FriendCategory(FriendCategory.const_457,getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in getSortedFriends(_loc2_.friends))
         {
            var_343.addFriend(new Friend(_loc4_));
         }
         var_386 = new FriendListTabs(new FriendListTabsDeps(this));
         _loc5_ = new Timer(120000);
         _loc5_.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
         _loc5_.start();
         getBuddyRequests();
         registerListeners();
         var_198.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_112,HabboToolbarIconEnum.FRIENDLIST));
      ...
      {
         var_343.onFriendListUpdate(param1);
      ...
      {
         var _loc2_:IAvatarImage = var_1590.createAvatarImage(param1,AvatarScaleType.const_102);
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1590 = param2 as IAvatarRenderManager;
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_721.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_386.findTab(FriendListTab.const_99);
      ...
      {
         var_1589 = param2 as IHabboNotifications;
      ...
      public function getFriendCount(param1:Boolean, param2:Boolean) : int
      {
         ...
         return this.var_343.getFriendCount(param1,param2);
      }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            _view.openFriendList();
            _loc1_ = var_386.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_283));
            }
            else
            {
               switch(_loc1_.id)
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1336.searchReceived(_loc2_.friends,_loc2_.others);
