package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1386:String = "no_reqs_info";
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_295 && _loc4_.state != FriendRequest.const_330)
            {
               _loc3_.addAcceptedRequest(_loc4_.requestId);
               _loc4_.state = FriendRequest.const_295;
      ...
      {
         var_1413 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         var_1412 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         var_1412.procedure = onDismissAllButtonClick;
         var_1413.procedure = onAcceptAllButtonClick;
         refreshButtons();
      }
      ...
      public function refreshShading(param1:FriendRequest, param2:Boolean) : void
      {
         ...
         param1.view.color = _friendList.laf.getRowShadingColor(FriendListTab.const_99,param2);
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_295)
         {
         ...
         else if(param1.state == FriendRequest.const_781)
         {
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1413,_loc1_);
         setEnabled(var_1412,_loc1_);
      }
