package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1375:String = "noconvinfo";
      
      private static const const_1376:String = "messageinput";
      ...
      private var var_1097:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         super();
         _friendList = param1;
         var_1097 = new FriendListTabsView(_friendList);
      }
      ...
      private function prepare() : void
      {
         ...
         var_796 = IWindowContainer(var_28.content.findChildByName("main_content"));
         var_249 = IWindowContainer(var_28.content.findChildByName("footer"));
         var_1097.prepare(var_796);
         var_28.procedure = onWindow;
         var_28.content.setParamFlag(HabboWindowParam.const_811,false);
         var_28.content.setParamFlag(HabboWindowParam.const_1308,true);
         var_28.header.setParamFlag(HabboWindowParam.const_660,false);
         var_28.header.setParamFlag(HabboWindowParam.const_981,true);
         var_28.content.setParamFlag(HabboWindowParam.const_660,false);
         var_28.content.setParamFlag(HabboWindowParam.const_981,true);
         var_28.findChildByName("open_edit_ctgs_but").procedure = onEditCategoriesButtonClick;
         var_1096 = ITextWindow(var_28.findChildByName("info_text"));
         var_1096.text = "";
      ...
      private function refreshWindowSize() : void
      {
         ...
         var_249.y = Util.getLowestPoint(var_28.content);
         ...
         var_28.scaler.setParamFlag(HabboWindowParam.const_881,this._friendList.tabs.findSelectedTab() != null);
         var_28.scaler.setParamFlag(HabboWindowParam.const_660,false);
         var_28.scaler.setParamFlag(HabboWindowParam.const_811,false);
