package com.sulake.habbo.window.utils
{
   ...
   public class Logger extends Component implements ILogger
   {
      ...
      private var var_1508:ICoreWindowManager;
      ...
      {
         var_1508 = param2 as ICoreWindowManager;
         _window = var_1508.create("Logger::Output",HabboWindowType.const_284,WindowStyle.const_228,0 | 0 | 0 | 0,new Rectangle(0,0,180,240),loggerEventProc,"Logger") as IFrameWindow;
         var_351 = var_1508.create("Logger::Output::Text",HabboWindowType.const_1143,WindowStyle.const_228,0 | 0 | 0,new Rectangle(0,0,_window.content.width,_window.content.height),null,"") as ITextWindow;
