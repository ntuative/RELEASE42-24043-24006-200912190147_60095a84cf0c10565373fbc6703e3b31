package com.sulake.habbo.window.utils
{
   ...
   public class ProfilerOutput implements IDisposable
   {
      ...
      public function ProfilerOutput(param1:IProfiler, param2:IHabboWindowManager, param3:IWindowRenderer)
      {
         ...
         var_362.addStopEventListener(refresh);
      ...
      private function method_2(param1:IItemListWindow) : IWindowContainer
      {
      ...
      private function profilerWindowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param2.name == "footer_enable_toggle")
         {
            ...
            else if(param1.type == WindowEvent.const_548)
            {
               var_1059 = false;
               ITextWindow(_window.findChildByName("footer")).textColor = 4284900966;
            }
      ...
      {
         var _loc2_:Array = var_362.getProfilerAgentsInArray();
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            _window.dispose();
            _window = null;
            var_362.removeStopEventListener(refresh);
            var_362 = null;
            _windowManager = null;
            var_665 = null;
            _disposed = true;
