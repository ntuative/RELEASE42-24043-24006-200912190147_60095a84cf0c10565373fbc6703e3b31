package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, ICoreUpdateReceiver, IWindowContextStateListener
   {
      ...
      private var var_1216:IEventDispatcher;
      
      private var var_2284:uint = 0;
      
      private var var_1214:ProfilerAgentTask;
      
      private var var_1215:ProfilerOutput;
      ...
      public function HabboWindowManagerComponent(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         {
            var_201 = CoreComponent(param1).root.stage;
            _instance = this;
            var_1216 = Component(param1).events;
            var_813 = new Array();
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         var_295 = new Array(const_340);
         var _loc6_:int = 0;
         while(_loc6_ < const_340)
         {
            _loc5_ = new WindowContext("layer_" + _loc6_,var_665,this,_localization,var_201,new Rectangle(0,0,var_201.stageWidth,var_201.stageHeight),this);
            var_295[_loc6_] = _loc5_;
            _loc6_++;
         }
         var_407 = var_295[const_1086];
         registerUpdateReceiver(this,0);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         var_407.getMouseCursor().defineCustomCursorType(MouseCursorType.const_306,_loc7_);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         var_407.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1253,_loc7_);
      }
      ...
      {
         return var_295[param1].getDesktopWindow().getChildAt(var_407.getDesktopWindow().numChildren - 1);
      }
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(var_1215 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_1215 = new ProfilerOutput(_loc3_,this,var_665);
               var_1217 = new ProfilerAgentTask("Update","Event processing");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1217);
               var_1214 = new ProfilerAgentTask("Redraw","Window rasterizer");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1214);
               var_969 = true;
            }
         }
      }
      ...
      {
         return var_407.getWindowParser().windowToXMLString(param1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            var_1216.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_340 - 1;
            while(_loc2_ >= 0)
            {
         ...
         var_1216.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         ...
         var_1216.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      
      public function getLayoutByType(param1:uint, param2:uint) : XML
      {
         var _loc3_:Dictionary = var_813[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? var_813[0][param1] as XML : _loc4_;
      }
      ...
      {
         return var_407.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1227,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1324,param2.name + ": " + param2.toString());
            }
         }
      }
   }
