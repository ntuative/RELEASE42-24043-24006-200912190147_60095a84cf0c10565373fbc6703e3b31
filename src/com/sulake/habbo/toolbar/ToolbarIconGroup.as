package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconGroup
   {
      ...
      {
         return var_1228.indexOf(param1) > -1;
      }
      ...
      private function alignItems() : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:int = 0;
         while(_loc4_ < var_1227.length)
         {
            _loc2_ = var_673.indexOf(var_1227[_loc4_]);
            if(_loc2_ > -1)
            {
               _loc1_ = var_301[_loc2_];
               if(_loc1_.exists)
               {
                  _loc1_.changePosition(var_761 + _loc3_);
                  _loc3_ += var_1229;
               }
            }
            _loc4_++;
      ...
      public function getIconById(param1:String) : ToolbarIcon
      {
         ...
         return var_301[var_673.indexOf(param1)];
      }
