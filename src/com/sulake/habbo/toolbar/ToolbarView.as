package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private var var_1395:Number = 15;
      
      private var _events:IEventDispatcher;
      
      private var var_273:ToolbarBarMenuAnimator;
      
      private var var_1394:Number = 5;
      ...
      private var var_910:Boolean = true;
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         ...
         var_194 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_55,HabboWindowStyle.const_892,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         var_910 = String(_loc7_.relocate_by_drag.@state) == "true";
         if(var_910)
         {
         ...
         var_1128 = _loc7_.toolbar.@margin_bottom;
         var_1395 = _loc7_.toolbar.@min_group_margin;
         var_1394 = _loc7_.toolbar.@margin_to_extrabar;
         ...
         createGroupsFromXmlList(_loc8_,var_251,param1,param2,_window,var_273);
         createGroupsFromXmlList(_loc9_,var_523,param1,param2,var_194,var_273);
         alignWindows();
      }
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,var_131,var_438,param3);
         }
      }
      ...
      private function alignWindows() : void
      {
         ...
         else
         {
            ...
            if(false)
            {
               ...
               {
                  _loc7_ = Number(Math.max(var_1395,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1128) / -1));
               }
               else
               {
                  _loc7_ = Number(Math.max(var_1395,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1128) / -1));
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,var_131,var_438);
         }
      }
      ...
      private function getGroupForIcon(param1:String) : ToolbarIconGroup
      {
         ...
         _loc3_ = 0;
         while(_loc3_ < var_523.length)
         {
            _loc2_ = var_523[_loc3_];
            if(_loc2_.acceptsIcon(param1))
            {
               return _loc2_;
            }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,var_131,var_438);
         }
      }
