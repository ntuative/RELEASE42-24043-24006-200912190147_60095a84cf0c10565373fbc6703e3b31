package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorColorItem
   {
      ...
      private const const_1589:int = 8947848;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(var_1212.width,var_1212.height,true,0);
            _loc4_ = var_1212.clone();
            _loc4_.colorTransform(_loc4_.rect,var_831.colorTransform);
         ...
         if(_loc3_ != null)
         {
            _loc3_.bitmap = new BitmapData(var_968.width,var_968.height,true,16777215);
            _loc3_.bitmap.copyPixels(var_968,var_968.rect,new Point(0,0),null,null,true);
            if(!_isSelected)
            {
         ...
         if(false)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               _loc5_.bitmap.copyPixels(var_1389,var_1389.rect,new Point(0,0),null,null,true);
            }
         }
      }
