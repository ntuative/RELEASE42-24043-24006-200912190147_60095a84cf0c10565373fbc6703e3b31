package com.sulake.habbo.avatar.common
{
   public class CategoryData
   {
      ...
      public function get currentColour() : AvatarEditorColorItem
      {
         if(var_587 > -1)
         {
            return var_312[var_587] as AvatarEditorColorItem;
         }
         return null;
      }
      ...
      public function selectColour(param1:int) : AvatarEditorColorItem
      {
         ...
         if(var_587 >= 0)
         {
            _loc3_ = var_312[var_587];
            _loc3_.isSelected = false;
         }
         if(var_312.length > param1)
         {
            _loc2_ = var_312[param1] as AvatarEditorColorItem;
            _loc2_.isSelected = true;
         }
         var_587 = param1;
