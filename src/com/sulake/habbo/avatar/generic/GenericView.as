package com.sulake.habbo.avatar.generic
{
   ...
   public class GenericView implements IAvatarEditorCategoryView
   {
      ...
      public function GenericView(param1:GenericModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_672["null"] = new AvatarEditorGridView(param1,FigureData.const_54,param2,param3);
         attachImages();
      ...
      private function windowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               case "tab_boy":
                  var_88.categorySwitch(FigureData.const_81);
                  param1.stopPropagation();
                  break;
               case "tab_girl":
                  var_88.categorySwitch(FigureData.const_82);
                  param1.stopPropagation();
            }
         }
      ...
      {
         var _loc4_:AvatarEditorGridView = var_672[param1];
         if(_loc4_ != null)
         {
      ...
      public function switchCategory(param1:String) : void
      {
         ...
         var _loc4_:AvatarEditorGridView = var_672[var_1421];
         if(_loc4_ == null)
         {
            return;
         }
