package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      private var var_1342:ITabSelectorWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager)
      {
         ...
         if(var_1292 == null)
         {
            ...
            var_1292 = _controller.windowManager.buildFromXML(_loc3_.content as XML) as IWindowContainer;
         }
         if(var_1517 == null)
         {
      ...
      public function updateAvatar() : void
      {
         ...
         if(var_646 != null)
         {
            toggleCategoryView(var_646,true);
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         var_1342 = _window.findChildByName("mainTabs") as ITabSelectorWindow;
         attachImages();
         updateAvatar();
      }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         var_646 = param1;
         var_1342.setSelected(var_1342.getSelectableByName(param1));
         _window.invalidate();
      }
