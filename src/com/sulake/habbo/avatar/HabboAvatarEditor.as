package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return var_1015.getSetType(param1);
      }
      ...
      private function init() : void
      {
         ...
         if(!var_1016)
         {
            ...
            var_696["null"] = new FigureData(this);
            var_696["null"] = new FigureData(this);
            _loc1_ = var_696["null"];
            _loc2_ = var_696["null"];
            ...
            var_343 = new Map();
            var_343.add(AvatarEditorCategory.const_791,new GenericModel(this));
            var_343.add(AvatarEditorCategory.const_45,new HeadModel(this));
            var_343.add(AvatarEditorCategory.const_329,new TorsoModel(this));
            var_343.add(AvatarEditorCategory.const_1212,new LegsModel(this));
            var_343.add(AvatarEditorCategory.const_687,new WardrobeModel(this));
            var_1016 = true;
         }
      }
      ...
      private function requestSavedOutfits() : void
      {
         ...
         var _loc1_:WardrobeModel = var_343.getValue(AvatarEditorCategory.const_687);
         if(_loc1_ != null)
         {
         }
      }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return var_343.getValue(AvatarEditorCategory.const_687);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return var_1015.getPalette(param1);
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc7_ != null)
         {
            ...
            if(_loc8_)
            {
               ...
               _loc6_ = new AvatarEditorGridItem(AvatarEditorView.var_1292.clone() as IWindowContainer,param1,null,null,false);
            ...
            for each(_loc5_ in _loc7_.partSets)
            {
               _loc19_ = false;
               _loc20_ = true;
               if(_loc5_.gender == FigureData.const_1358)
               {
                  _loc19_ = true;
               }
               ...
               {
                  _loc6_ = new AvatarEditorGridItem(AvatarEditorView.var_1292.clone() as IWindowContainer,param1,_loc5_,_loc11_,_loc14_);
                  _loc3_.push(_loc6_);
               }
            }
         }
      ...
      {
         var _loc2_:IAvatarEditorCategoryModel = var_343.getValue(param1) as IAvatarEditorCategoryModel;
         if(_loc2_ != null)
         {
      ...
      public function openEditor(param1:IWindowContainer = null) : Boolean
      {
         ...
         else
         {
            if(var_407 == null)
            {
               var_407 = _windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_55,HabboWindowStyle.const_39,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               var_407.addChild(_view.window);
               var_407.center();
               var_407.visible = false;
            }
            var_407.visible = true;
         }
         _view.show();
         toggleAvatarEditorPage(AvatarEditorCategory.const_791);
         if(var_178 != null)
         {
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_1064 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,onAvatarRendererReady);
      }
      ...
      private function onInventoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_25 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_605,onHabboClubChanged);
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         var_1015 = var_1064.getFigureData(AvatarType.HUMAN);
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:Boolean = false) : void
      {
         ...
         var_1017 = param3;
         var _loc4_:FigureData = var_696[param2];
         if(_loc4_ == null)
         {
            return;
         }
