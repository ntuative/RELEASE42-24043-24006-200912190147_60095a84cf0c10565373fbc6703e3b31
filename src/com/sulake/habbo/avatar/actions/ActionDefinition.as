package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         var_1564 = parseInt(param1.@precedence);
         var_1560 = String(param1.@activepartset);
         var_1567 = String(param1.@assetpartdefinition);
         var_1566 = String(param1.@lay);
         var_1109 = String(param1.@geometrytype);
         var_1561 = Boolean(parseInt(param1.@main));
         var_1563 = Boolean(parseInt(param1.@method_11));
         var_1562 = Boolean(parseInt(param1.@animation));
         var _loc2_:String = String(param1.@prevents);
         if(_loc2_ != "")
         {
            var_1062 = _loc2_.split(",");
         }
      ...
      public function setOffsets(param1:String, param2:int, param3:Array) : void
      {
         ...
         {
            var_512.add(param1,new Map());
         }
         var _loc4_:Map = var_512.getValue(param1);
      ...
      public function getOffsets(param1:String, param2:int) : Array
      {
         ...
         var _loc3_:Map = var_512.getValue(param1) as Map;
         if(_loc3_ == null)
         {
            return null;
         }
      ...
      {
         return var_1062.concat(getTypePrevents(param1));
      }
