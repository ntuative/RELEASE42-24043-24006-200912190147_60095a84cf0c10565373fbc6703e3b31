package com.sulake.habbo.avatar.head
{
   ...
   public class HeadView implements IAvatarEditorCategoryView
   {
      ...
      public function HeadView(param1:HeadModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_672["null"] = new AvatarEditorGridView(param1,FigureData.const_108,param2,param3);
         var_672["null"] = new AvatarEditorGridView(param1,FigureData.const_131,param2,param3);
         var_672["null"] = new AvatarEditorGridView(param1,FigureData.const_132,param2,param3);
         var_672["null"] = new AvatarEditorGridView(param1,FigureData.const_143,param2,param3);
         var_672["null"] = new AvatarEditorGridView(param1,FigureData.const_139,param2,param3);
         attachImages();
      ...
      private function changeToCurrentTab() : void
      {
         ...
         var _loc2_:AvatarEditorGridView = var_672[var_1421];
         if(_loc2_ == null)
         {
            return;
         }
