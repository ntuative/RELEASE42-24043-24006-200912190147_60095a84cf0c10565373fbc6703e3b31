package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_1936:PartOffsetData;
      
      private var var_800:AvatarActionManager;
      
      private var var_158:IAssetLibrary;
      
      private var var_2192:IAssetLibrary;
      
      private var var_1293:Boolean = false;
      
      private var var_1937:AvatarRenderManager;
      
      private var var_461:FigureData;
      ...
      private var var_1448:AvatarStructureDownloadSet;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_158 = param2;
         var_2192 = param3;
         var_461 = new FigureData();
         var_391 = new PartSetsData();
         _animationData = new AnimationData();
         var_1448 = new AvatarStructureDownloadSet();
         var_652 = new AnimationManager();
         var_653 = param4;
         var_1936 = PartOffsetData.getInstance(param3);
         init();
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = var_652.getAnimation(_loc6_);
            if(_loc7_ != null)
            {
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1273[param3];
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int) : Array
      {
         ...
         if(param3.definition.isAnimation)
         {
            ...
            _loc8_ = var_652.getAnimation(_loc17_);
            if(_loc8_ != null)
            {
         ...
         for each(_loc14_ in param2.getPartTypeIds())
         {
            ...
            _loc23_ = var_461.getSetType(_loc14_);
            if(_loc23_ != null)
            {
               _loc24_ = var_461.getPalette(_loc23_.paletteID).getColor(_loc22_);
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         {
            case AvatarType.HUMAN:
               var_1448.add(new AvatarStructureDownload(var_158,_loc5_,var_461));
               break;
            case AvatarType.PET:
         }
         var_1448.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return var_652.getAnimation(param1);
      }
      ...
      {
         var_800 = new AvatarActionManager(var_158,var_653);
      }
      ...
      private function registerAnimations() : void
      {
         ...
         while(var_158.hasAsset("dance" + _loc1_))
         {
            ...
            var_652.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
      ...
      public function getPartColor(param1:AvatarFigureContainer, param2:String) : IPartColor
      {
         ...
         var _loc4_:ISetType = var_461.getSetType(param2);
         if(_loc4_ == null)
         {
            return null;
         }
         return var_461.getPalette(_loc4_.paletteID).getColor(_loc3_);
      }
