package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1380:int = 60000;
      ...
      private var var_775:IAvatarImage;
      ...
      public function getAnimationDataInFrame(param1:String, param2:int) : AnimationLayerData
      {
         ...
         return var_76.getBodyPartData(_loc4_.definition.state + "." + _loc4_.actionParameter,param2,param1);
      }
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         {
            _loc15_ = var_76.getBodyPartData(_loc5_.definition.state + "." + _loc5_.actionParameter,param2,param1);
            if(_loc15_ != null)
            {
               ...
               if(_loc15_.type == AnimationLayerData.const_719)
               {
         ...
         if(_loc14_ == null)
         {
            ...
            _loc10_ = var_76.getParts(param1,(var_775 as AvatarImage).getFigure(),_loc6_,var_1109,_loc4_);
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         var _loc5_:AvatarCanvas = var_76.getCanvas(var_191,var_1109);
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         while(_loc28_ >= 0)
         {
            ...
            if(AvatarDirectionAngle.const_1230[param1])
            {
            ...
            else
            {
               ...
               {
                  _loc34_ = var_76.renderManager.paletteManager.getPalette(_loc7_.paletteMapId);
               ...
               if((_loc32_ == AvatarAction.const_995 || _loc32_ == AvatarAction.const_612) && (_loc6_ == AvatarBodyPartType.const_329 || _loc6_ == AvatarBodyPartType.const_1170 || _loc6_ == AvatarBodyPartType.const_1346) && _loc7_.color != null)
               {
      ...
      public function setAction(param1:IActiveActionData) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:Array = var_76.getActiveBodyPartIds(param1);
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc3_:Array = var_76.getBodyPartsUnordered(param1);
