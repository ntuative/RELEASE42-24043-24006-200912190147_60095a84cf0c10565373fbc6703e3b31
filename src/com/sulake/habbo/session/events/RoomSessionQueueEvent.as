package com.sulake.habbo.session.events
{
   ...
   public class RoomSessionQueueEvent extends RoomSessionEvent
   {
      ...
      public static const const_374:String = "RSQE_QUEUE_STATUS";
      
      public static const const_826:int = 2;
      
      public static const const_918:String = "c";
      ...
      {
         super(const_374,param1,param5,param6);
         _name = param2;
         _target = param3;
         var_1088 = new Map();
         var_266 = param4;
      ...
      {
         return var_1088.getValue(param1);
      }
