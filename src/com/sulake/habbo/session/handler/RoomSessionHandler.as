package com.sulake.habbo.session.handler
{
   ...
   public class RoomSessionHandler extends BaseHandler
   {
      ...
      public static const const_854:String = "RS_CONNECTED";
      
      public static const const_544:String = "RS_DISCONNECTED";
      
      public static const const_1002:String = "RS_READY";
      ...
      private function onRoomDisconnected(param1:IMessageEvent) : void
      {
         ...
         if(listener)
         {
            listener.sessionUpdate(_loc2_,_loc3_,RoomSessionHandler.const_544);
         }
      }
      ...
      private function onRoomConnected(param1:IMessageEvent) : void
      {
         ...
         if(listener)
         {
            listener.sessionUpdate(_loc2_,_loc3_,RoomSessionHandler.const_854);
         }
      }
   }
}
