package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, ICoreUpdateReceiver
   {
      ...
      private static const const_760:uint = 11;
      ...
      private var var_392:IHabboHelp;
      
      private var _coreComponent:CoreComponent;
      
      private var var_963:int = -1;
      
      private var var_1191:LagWarningLogger = null;
      
      private var var_804:IHabboWindowManager;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_1191 = new LagWarningLogger();
         var_1192 = new Array(const_760);
         var _loc4_:int = 0;
         while(_loc4_ < const_760)
         {
            var_1192[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1136,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1297,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_701,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_941,String(0));
         }
      ...
      {
         var_69 = IHabboCatalog(param2) as IHabboCatalog;
         var_69.events.addEventListener(CatalogPageOpenedEvent.CATALOG_PAGE_OPENED,onCatalogPageOpened);
         var_69.events.addEventListener(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_OPEN,onCatalogTrackingEvent);
         var_69.events.addEventListener(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_CLOSE,onCatalogTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_283:
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_178)
         {
            Component(var_178).events.addEventListener(HabboConfigurationEvent.const_18,onConfigurationLoaded);
            if(var_231 != null)
            {
               var_231.configuration = var_178;
            }
            if(var_230 != null)
            {
               var_230.configuration = var_178;
            }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_483.events.addEventListener(AdEvent.const_361,onRoomAdLoad);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_941,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_701,String(true));
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_561,onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_681,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_60,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_438,onHotelViewEvent);
      }
      ...
      private function onLagWarningEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case AvatarWalkWarpingWarningEvent.const_367:
               var_1191.registerWarning(LagWarningLogger.const_906);
         }
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(var_804)
            {
               var_804.release(new IIDHabboWindowManager());
               var_804 = null;
            }
            if(var_483)
            {
               var_483.release(new IIDHabboAdManager());
               var_483 = null;
            }
            if(_navigator)
            {
            ...
            if(var_69)
            {
               if(true)
               {
                  var_69.events.removeEventListener(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_CLOSE,onCatalogTrackingEvent);
                  var_69.events.removeEventListener(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_OPEN,onCatalogTrackingEvent);
               }
               var_69.release(new IIDHabboCatalog());
               var_69 = null;
            }
            if(var_25)
            {
            ...
            if(var_177)
            {
               if(true)
               {
                  ...
                  Component(var_177).events.removeEventListener(HabboFriendListTrackingEvent.const_283,onFriendlistTrackingEvent);
               }
            ...
            if(var_392)
            {
               if(true)
               {
                  var_392.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
                  var_392.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
               }
               var_392.release(new IIDHabboHelp());
               var_392 = null;
            }
            if(_roomEngine)
            {
               if(true)
               {
                  Component(_roomEngine).events.removeEventListener(AvatarWalkWarpingWarningEvent.const_367,onLagWarningEvent);
               }
            }
      ...
      private function onConfigurationLoaded(param1:Event) : void
      {
         ...
         if(var_178)
         {
            Component(var_178).events.removeEventListener(HabboConfigurationEvent.const_18,onConfigurationLoaded);
         }
      }
      ...
      private function onLocalizationLoaded(param1:Event) : void
      {
         ...
         if(_localization)
         {
            Component(_localization).events.removeEventListener(LocalizationEvent.const_21,onLocalizationLoaded);
         }
      }
      
      private function onHelpReady(param1:IID, param2:IUnknown) : void
      {
         var_392 = param2 as IHabboHelp;
         var_392.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
         var_392.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
      }
      ...
      private function onCoreRunning(param1:Event) : void
      {
         ...
         {
            _coreComponent.events.removeEventListener(HabboLoginTrackingStep.const_25,onCoreRunning);
         }
      }
      ...
      {
         var_804 = IHabboWindowManager(param2);
         if(var_804)
         {
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(_roomEngine).events.addEventListener(AvatarWalkWarpingWarningEvent.const_367,onLagWarningEvent);
         Component(_roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_252,onRoomAdClick);
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(var_177).events.addEventListener(HabboFriendListTrackingEvent.const_283,onFriendlistTrackingEvent);
      }
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(_localization)
         {
            Component(_localization).events.addEventListener(LocalizationEvent.const_21,onLocalizationLoaded);
         }
      }
      
      private function onHotelViewEvent(param1:Event) : void
      {
         if(param1.type == HabboHotelViewEvent.const_681)
         {
            trackLoginStep(HabboLoginTrackingStep.const_22);
         }
         else if(param1.type == HabboHotelViewEvent.const_438)
         {
