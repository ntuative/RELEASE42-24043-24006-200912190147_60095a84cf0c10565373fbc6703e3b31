package com.sulake.habbo.widget.chooser
{
   ...
   public class ChooserWidget extends RoomWidgetBase
   {
      ...
      private var var_414:ChooserView;
      ...
      private function onChooserContent(param1:RoomWidgetChooserContentEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChooserContentEvent.const_370:
               if(var_414 == null)
               {
                  var_414 = new ChooserView(this,"${widget.chooser.furni.title}");
               }
               if(var_414 == null)
               {
                  return;
               }
               var_414.populate(param1.items,param1.isAnyRoomController);
               break;
            case RoomWidgetChooserContentEvent.const_476:
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetChooserContentEvent.const_370,onChooserContent);
         param1.addEventListener(RoomWidgetChooserContentEvent.const_476,onChooserContent);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_105,onUpdateFurniChooser);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_618,onUpdateFurniChooser);
      ...
      {
         if(var_414 == null || !var_414.isOpen())
         {
            return;
         }
         var _loc2_:RoomWidgetRequestWidgetMessage = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_386);
      ...
      {
         var _loc3_:RoomWidgetRoomObjectMessage = new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_590,param1,param2);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetChooserContentEvent.const_370,onChooserContent);
         param1.removeEventListener(RoomWidgetChooserContentEvent.const_476,onChooserContent);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_105,onUpdateFurniChooser);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_618,onUpdateFurniChooser);
