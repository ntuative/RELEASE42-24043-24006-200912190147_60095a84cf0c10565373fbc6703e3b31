package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_483:int = 6;
      
      private static const const_337:int = 10;
      
      private static const const_1054:Number = 18;
      
      private static const const_1387:Number = 10;
      
      private static const const_1388:Number = 8;
      ...
      {
         _widget.onItemMouseOut(var_927,var_925,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_927,var_925,_roomId,_roomCategory,param1);
      }
      ...
      public function method_9(param1:RoomWidgetChatUpdateEvent) : void
      {
         var_1150 = param1.chatType;
         var_927 = param1.userId;
         var_762 = param1.userName;
         var_925 = param1.userCategory;
         _message = param1.text;
         var_1152 = param1.userX;
         var_196 = param1.userImage;
      ...
      public function renderView() : void
      {
         ...
         switch(var_1150)
         {
            ...
            case RoomWidgetChatUpdateEvent.const_100:
               _loc1_ = "bubble_shout";
               break;
            case RoomWidgetChatUpdateEvent.const_225:
               _loc1_ = "bubble_generic";
               _loc2_ = true;
               break;
            case RoomWidgetChatUpdateEvent.const_256:
               _loc1_ = "bubble_generic";
               _loc2_ = true;
         }
         ...
         if(var_196 != null)
         {
            ...
            _loc16_ = Math.max(_loc16_,var_196.height);
         }
         ...
         if(var_196 != null && !_loc2_)
         {
            ...
            if(_loc28_ != null)
            {
               _loc28_.width = var_196.width;
               _loc28_.height = var_196.height;
               _loc28_.bitmap = new BitmapData(var_196.width,var_196.height,true,0);
               _loc28_.bitmap.copyPixels(var_196,var_196.rect,new Point(0,0));
               _loc28_.x = _loc26_;
               _loc28_.y = _loc27_;
               var_377 = Math.max(0,(0 - _loc5_.height) / 2);
               _width += var_196.width;
            }
         }
         if(_loc18_ != null)
         {
            ...
            if(var_926 != 0)
            {
               _loc31_ = uint(var_926 >> 16 & 255);
               _loc32_ = uint(var_926 >> 8 & 255);
               _loc33_ = uint(var_926 >> 0 & 255);
            }
         ...
         if(_loc20_ != null)
         {
            if(var_1150 == RoomWidgetChatUpdateEvent.const_225)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_762);
            }
            else if(var_1150 == RoomWidgetChatUpdateEvent.const_256)
            {
            ...
            _loc20_.x = _width;
            _loc20_.y += var_377;
            _loc20_.width = _loc20_.textWidth + const_483;
            _width += _loc20_.textWidth + const_483;
         }
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_337 + _loc20_.textWidth + const_483;
            _loc38_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_927,var_925,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_927,var_925,_roomId,_roomCategory,param1);
      }
