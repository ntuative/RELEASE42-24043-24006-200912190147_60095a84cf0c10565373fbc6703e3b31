package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1396:int = 5;
      
      private static const const_483:int = 16;
      ...
      private var var_412:Number = 600;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_2006 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_2005 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_670 = new Timer(1000,1);
         var_670.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
         var_820 = new Timer(5000,1);
         var_820.addEventListener(TimerEvent.TIMER_COMPLETE,onIdleTimerComplete);
         createWindow();
         refreshView();
      }
      ...
      private function createWindow() : void
      {
         ...
         _loc4_.addEventListener(WindowKeyboardEvent.const_127,windowKeyEventProcessor);
         _loc4_.addEventListener(WindowEvent.const_43,onInputFieldResized);
         _loc4_.addEventListener(WindowEvent.const_193,onInputChanged);
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_2007 = _loc2_.width + const_483 + _loc6_.width + const_1088;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1089,_loc8_.width) + const_483);
            _loc8_.x = _loc12_;
      ...
      public function setMaxWidth(param1:Number) : void
      {
         ...
         {
            _loc3_ = Math.min(int(_loc2_.textWidth),var_412);
         }
         else
         {
            _loc3_ = Math.min(_loc3_,var_412);
         }
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(var_471);
