   ...
   public class DimmerViewColorGrid
   {
      ...
      private function populateColourGrid(param1:IHabboWindowManager) : void
      {
         ...
         for each(_loc2_ in colors)
         {
            ...
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(var_850.width,var_850.height,true,0);
            ...
            if(_loc6_ != null)
            {
               _loc6_.bitmap = new BitmapData(var_693.width,var_693.height,true,16777215);
               _loc6_.bitmap.copyPixels(var_693,var_693.rect,new Point(0,0),null,null,true);
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         var_850 = BitmapData(_loc3_.content);
         _loc3_ = BitmapDataAsset(param1.getAssetByName("dimmer_color_selected"));
         var_693 = BitmapData(_loc3_.content);
      }
