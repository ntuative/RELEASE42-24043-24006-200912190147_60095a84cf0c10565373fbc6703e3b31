package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewAlphaSlider
   {
      ...
      {
         if(param1.type != WindowMouseEvent.const_97 && param1.type != WindowMouseEvent.const_567)
         {
            return;
         }
      ...
      {
         return int(param1 / var_1463 * (var_966 - var_656)) + var_656;
      }
   }
}
