package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = var_681[var_998] as Dictionary;
      ...
      private function showCancelConfirm() : void
      {
         ...
         if(!var_302)
         {
            ...
            var_302 = _widget.windowManager.buildFromXML(_loc1_.content as XML,2);
            var_302.center();
            var_302.procedure = cancelConfirmEventProc;
         }
      }
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++var_998;
         if(var_998 < var_681.length)
         {
            _loc1_ = var_681[var_998] as Dictionary;
            if(!_loc1_)
            {
            ...
            if(_window)
            {
               ...
               if(_loc2_)
               {
                  ...
                  _loc6_ = _loc6_.replace("%count%",var_681.length);
                  _loc2_.text = _loc6_;
               }
