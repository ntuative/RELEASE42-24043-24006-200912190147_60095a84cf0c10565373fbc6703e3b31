   ...
   public class EffectView
   {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            var_793 = _window.findChildByName("effect_hilite");
            var_793.visible = false;
         }
         var_792 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_791 = _window.findChildByName("loader_bar");
         if(var_791 != null)
         {
            var_412 = var_791.width;
            var_179.start();
            onUpdate();
         }
         if(false)
      ...
      private function setTimeLeft() : void
      {
         ...
         if(var_792 != null)
         {
            var_792.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = "null";
            if(false)
            {
               _loc2_ = 0;
            ...
            {
               var_792.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
