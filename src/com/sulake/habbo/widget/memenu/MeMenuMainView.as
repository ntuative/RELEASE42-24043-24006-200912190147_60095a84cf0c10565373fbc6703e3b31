      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "dance":
               ...
               _widget.changeView(MeMenuWidget.const_834);
               break;
            case "wave":
               if(false)
               {
            ...
            case "effects":
               ...
               _widget.changeView(MeMenuWidget.const_690);
               break;
            case "rooms":
               ...
               break;
            case "badges":
               _widget.messageListener.processWidgetMessage(new RoomWidgetOpenInventoryMessage(RoomWidgetOpenInventoryMessage.const_775));
               _widget.hide();
               break;
            case "clothes":
