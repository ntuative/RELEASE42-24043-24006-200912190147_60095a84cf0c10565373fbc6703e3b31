package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1599:uint = 6710886;
      
      private var _window:IItemListWindow;
      
      private const const_1596:String = "level";
      
      private var var_110:IItemListWindow;
      
      private const const_1598:String = "energy";
      
      private var var_1098:Map;
      
      private const const_1595:String = "nutrition";
      ...
      private const const_1601:int = 158;
      
      private const const_1593:int = 16;
      
      private var _widget:InfostandWidget;
      
      private var var_265:PetCommandTool;
      
      private const const_1597:uint = 11184810;
      
      private const const_1594:String = "experience";
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(var_229 != null)
         {
            var_110 = var_229.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
      ...
      {
         if(var_110 == null || var_229 == null || var_65 == null)
         {
            return;
         }
         ...
         var_229.height = NaN;
         _window.width = Math.max(var_229.width,var_65.width);
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = var_1098.getValue(var_647) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         ageText = param1.age;
         updateStateElement(const_1596,param1.level,param1.levelMax);
         updateStateElement(const_1594,param1.experience,param1.experienceMax);
         updateStateElement(const_1598,param1.energy,param1.energyMax);
         updateStateElement(const_1595,param1.nutrition,param1.nutritionMax);
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_473,_widget.petData.ownerId);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1601,const_1593,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),const_1597);
         ...
         _loc5_.fillRect(_loc7_,const_1599);
         return _loc5_;
      }
