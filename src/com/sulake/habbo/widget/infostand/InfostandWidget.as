package com.sulake.habbo.widget.infostand
{
   ...
   public class InfostandWidget extends RoomWidgetBase
   {
      ...
      private var var_781:InfoStandFurniView;
      
      private var var_404:InfostandFurniData;
      
      private var var_332:InfoStandBotView;
      ...
      private const const_1391:String = "infostand_furni_view";
      ...
      public function InfostandWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager)
      {
         ...
         _config = param4;
         var_781 = new InfoStandFurniView(this,const_1391);
         var_197 = new InfoStandUserView(this,const_1393);
         var_291 = new InfoStandPetView(this,const_1392);
         var_332 = new InfoStandBotView(this,const_1390);
         var_399 = new InfostandUserData();
         var_404 = new InfostandFurniData();
         var_1098 = new InfoStandPetData();
         var_135 = new Timer(const_1591);
      ...
      private function onUserTags(param1:RoomWidgetUserTagsUpdateEvent) : void
      {
         ...
         {
            var_197.setTags(param1.tags,var_1873);
         }
      }
      ...
      private function onUpdateTimer(param1:TimerEvent) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_376,var_291.getCurrentPetId()));
      }
      ...
      private function onBadgeImage(param1:RoomWidgetBadgeImageUpdateEvent) : void
      {
         ...
         if(_loc2_ >= 0)
         {
            if(userData.isBot())
            {
               var_332.setBadgeImage(_loc2_,param1.badgeImage);
            }
            else
            {
      ...
      private function onRoomObjectRemoved(param1:RoomWidgetRoomObjectUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetRoomObjectUpdateEvent.const_245:
               ...
               if(var_332 != null && false && var_332.window.visible)
               {
                  _loc2_ = param1.id == var_399.userRoomId;
                  break;
               }
