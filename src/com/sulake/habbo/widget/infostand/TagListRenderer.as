package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_1586:int = 5;
      ...
      {
         var _loc2_:* = null;
         if(var_1188 != null && var_1188.indexOf(param1) != -1)
         {
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         if(var_747 + param1.height > _rect.height)
         {
            return false;
         }
         ...
         {
            _offsetX = 0;
            var_747 += param1.height + const_1586;
            return fit(param1);
         }
         param1.offset(_offsetX,var_747);
         _offsetX += param1.width + const_1587;
         return true;
      }
