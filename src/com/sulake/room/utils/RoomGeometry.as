package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      {
         if(var_396 != param1 * var_1481)
         {
            var_396 = param1 * var_1481;
            ++var_85;
         }
      }
      ...
      {
         if(var_397 != param1 * var_1480)
         {
            var_397 = param1 * var_1480;
            ++var_85;
         }
      }
      ...
      {
         if(var_395 != param1 * var_1479)
         {
            var_395 = param1 * var_1479;
            ++var_85;
         }
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            var_988.assign(_loc22_);
         }
         else
         {
            var_988.assign(_loc17_);
         }
         ++var_85;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= var_395;
         _loc2_.z *= var_396;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,var_988);
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= var_395;
            _loc2_.z *= var_396;
            _loc3_ = Vector3d.scalarProjection(_loc2_,var_988);
         }
      ...
      {
         return new Vector3d(0 * var_397,0 * var_395,0 * var_396);
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(0 * var_397,0 * var_395,0 * var_396);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_90;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_397,param2.y * var_395,param2.z * var_396);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_397,param3.y * var_395,param3.z * var_396);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_397,param4.y * var_395,param4.z * var_396);
